...
| Aeldrune logo, wordmark, application icons, and splash derivatives (`public/aeldrune-logo.png`, web icons, `build/icon.*`, Android launcher/splash assets, and iOS app icon/splash assets) | Project owner | Owner-provided original logo, with platform derivatives generated locally from the supplied master | Project asset, rights reserved | **No, permission required** |
