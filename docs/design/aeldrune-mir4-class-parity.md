...
| --- | --- |
| Warrior | Void Slash, Lion's Roar, Riposte, Rampant, Barbaric Charge, Splitting Slash, Gale Slash, Iron Shackle, Crescent Strike, Body Check, Ground Smash, Unbreakable Stance |
...
* One regular skill is available at creation; the remaining regular skills unlock every ten levels through level 110.
* The class Ultimate unlocks at level 50 and uses its own combat gauge.
