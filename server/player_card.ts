...
export const PUBLIC_CARD_COPY: Record<PublicCardLocale, PublicCardCopy> = {
  en: {
    ...
    description: '{name} is forging a legend in Aeldrune. Join the realm.',
  ...
  es: {
    ...
    description: '{name} está forjando una leyenda en Aeldrune. Únete al reino.',
  ...
  fr_FR: {
    ...
    description: '{name} forge sa légende dans Aeldrune. Rejoignez le royaume.',
    ...
    missingCta: 'Entrer dans Aeldrune',
    classes: {
      warrior: 'Guerrier',
      paladin: 'Paladin',
      hunter: 'Chasseur',
  ...
  it_IT: {
    ...
    description: '{name} sta forgiando una leggenda in Aeldrune. Entra nel reame.',
  ...
  de_DE: {
    ...
    description: '{name} schmiedet eine Legende in Aeldrune. Betretet das Reich.',
  ...
  zh_CN: {
    ...
    description: '{name} 正在 Aeldrune 中铸就传奇。加入这个国度。',
    cta: '铸就你的传奇',
    missingTitle: '未找到卡片',
    missingHeading: '这张卡片已不可用。',
    missingDescription: '它可能已被撤下，或从未存在。',
    missingCta: '进入 Aeldrune',
    classes: {
      warrior: '战士',
      paladin: '圣骑士',
      hunter: '猎人',
  ...
  zh_TW: {
    ...
    description: '{name} 正在 Aeldrune 中鑄就傳奇。加入這個國度。',
    cta: '鑄就你的傳奇',
    missingTitle: '找不到卡片',
    missingHeading: '這張卡片已不可用。',
    missingDescription: '它可能已被移除，或從未存在。',
    missingCta: '進入 Aeldrune',
    classes: {
      warrior: '戰士',
      paladin: '聖騎士',
      hunter: '獵人',
  ...
  pt_BR: {
    ...
    description: '{name} está forjando uma lenda em Aeldrune. Entre no reino.',
    cta: 'Forje sua lenda',
  ...
  ru_RU: {
    ...
    description: '{name} создает легенду в Aeldrune. Присоединяйтесь к миру.',
