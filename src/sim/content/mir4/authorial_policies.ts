...
export const MIR4_AUTHORIAL_SKILL_POLICIES: Readonly<Record<number, Mir4AuthorialSkillPolicy>> = {
  ...
  5201: {
    model: 'mir4-authorial-skill-policy-v1',
    policyVersion: 'mir4-authorial-combat-v1',
    policyId: 'mir4-authorial.class5.skill5201.hybrid-v1',
    authority: 'authorial-browser-reconstruction',
    nativeClaim: false,
    classId: 5,
    skillId: 5201,
    slot: 1,
    label: 'Hybrid strike (physical + magic)',
    resolvesNativeUnknowns: [
      'DamageType=3 composition: physical and magic coefficients are summed',
      'DamageType=3 dispatch routing is treated as the recovered FUN_14018F810 path',
    ],
    nativeBlockerStatus: 'blocked-source-damage-type-3',
    damage: {
      damageType: 'hybrid',
      physicalAttack: 50,
      magicAttack: 50,
      physicalCoefficient: 10000,
      magicCoefficient: 14000,
      impactCount: 6,
      allocationMode: 'browser-immediate-component-vector',
      levelOneDamage: 120,
    },
    ...
    effects: null,
    autoCondition: null,
    policySha256: 'd9802a609699bb15d6cbb035f87515951640c0d3715063dec67056a154cf7084',
  },
};
