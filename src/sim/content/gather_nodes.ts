...
export const GATHER_NODES: GatherNodeDef[] = [
  ...
  // Aeldrune campaign mining veins. The original WoC expansion zones each
  // shipped two veins near their first regional hub. The transplanted MIR4
  // chapters reuse several of those zones at distinct physical locations, so
  // these authored veins make every later chapter a real mining district
  // instead of assigning rewards to a remote node from another map chapter.
  {
    id: 'ore_nightbloom_m07_1',
    zoneId: 'nightbloom',
    type: 'ore',
    pos: { x: -383, z: 1697 },
    level: 20,
