...
export const FROSTVEIL_ZONE: ZoneDef = {
  ...
  pois: [
    ...
    { x: -90, z: 1760, label: "The Shiverfen", id: "the_shiverfen" },
    {
      ...
      id: "the_howling_terraces",
    },
  ],
  welcome:
    "Snow swallows every sound. Under the dancing lights, the cold itself feels awake.",
...
export const FROSTVEIL_ROADS: { x: number; z: number }[][] = [
  ...
  [
    { x: 34, z: 1640 },
    { x: 45, z: 1640.5 },
  ], // the authored Glacier Tarn escape ramp, connected to the road graph
  [
    { x: -30, z: 1560 },
    { x: -70, z: 1660 },
    { x: -78, z: 1746 },
  ...
  [
    ...
    { x: 168, z: 1880 },
    { x: 176, z: 1888 },
  ], // the old Snowline shelf -> the high crossing by a visible switchback
  [
    { x: 30, z: 1740 },
    { x: -40, z: 1800 },
    { x: -120, z: 1860 },
  ...
  [
    ...
    { x: 80, z: 1694 },
    { x: 130, z: 1760 },
    // The main ascent follows the gentler Snowline grade. The separate
    // switchback above keeps the old (120, 1840) save position physically
    // connected without sharpening this ascent back into its old hairpin.
    { x: 132, z: 1792 },
    { x: 168, z: 1880 },
    { x: 176, z: 1888 },
...
export const FROSTVEIL_NPCS: Record<string, NpcDef> = {
  ...
  hearthkeeper_maeve: {
    ...
    greeting:
      "Come in off the cold. The lodge fire never goes out, so long as I draw breath.",
  },
  scout_einna: {
    id: "scout_einna",
    name: "Scout Einna",
  ...
  aurorist_veyla: {
    ...
    // Stand on the road-side edge of the camp. The old seat at (32, 1744)
    // was pinched between the tent and fire, leaving campaign actors seated
    // there just beyond the Auto Mission interaction radius.
    pos: { x: 27, z: 1738 },
    facing: -2.2,
    color: 0xb8a2e0,
    questIds: [
    ...
    greeting:
      "Hush. The lights are speaking tonight, and they do not repeat themselves.",
  },
  trapper_brosk: {
    id: "trapper_brosk",
    name: "Trapper Brosk",
    ...
    greeting:
      "Fen took three of my lines this week. Fen never took a line in twenty years.",
  },
};
...
export const FROSTVEIL_QUESTS: Record<string, QuestDef> = {
  ...
  q_fv_sprung_traps: {
    ...
    objectives: [
      {
        type: "kill",
        targetMobId: "fen_sprite",
        count: 8,
        label: "Fen Sprite driven off",
      },
      {
        type: "interact",
        targetObjectItemId: "sprung_trap",
        count: 4,
...
export const FROSTVEIL_ESCORTS: Record<string, EscortDef> = {
  esc_fv_wren: {
    ...
    respawnSeconds: 30,
    startText:
      "You'll walk with me? Stay close, please. The wolves have been circling since dusk.",
    successText:
