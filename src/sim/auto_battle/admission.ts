...
// classic and MIR4 hard control.

import { mir4HardControlled, mir4MovementMultiplierFromShared } from '../mir4/effects';
import type { SimContext } from '../sim_context';
import type { Entity } from '../types';
import { RUN_SPEED } from '../types';

export function mir4AutomationActionBlocked(ctx: SimContext, player: Entity): boolean {
  return ctx.isRooted(player) || mir4HardControlled(player);
}
