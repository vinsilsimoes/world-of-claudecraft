...
export const en = {
  ...
  wallet: {
    ...
    standaloneAppHelp:
      'Wallet connections are not available in the Home Screen app yet. Open Aeldrune in Safari or Chrome to use Phantom or Solflare.',
    ...
    manualReturnStandaloneHelp:
      'After approval, return to Aeldrune from your Home Screen. If iOS opens a browser, close it and reopen the Home Screen app manually.',
    ...
    browser: {
      ...
      safety: 'Aeldrune never asks for your recovery phrase or private key.',
      ...
      completeBody: 'You can return to the Aeldrune desktop app.',
  ...
  playerCard: {
    ...
    shareText:
      "I'm forging my legend in Aeldrune: Level {level} {className}{tierBit}. Join my world:",
    nativeShareTitle: 'Aeldrune',
