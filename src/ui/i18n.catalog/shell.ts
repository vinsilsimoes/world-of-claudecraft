...
export const shellStrings = {
  en: {
    seo: {
      ...
      officialBody:
        'Aeldrune is the official browser MMORPG set in Aelvarin. Create a persistent character, follow the campaign and consult the in-game wiki.',
    },
    a11y: {
      ...
      githubProject: 'Aeldrune GitHub coming later',
      discordCommunity: 'Aeldrune community channel coming later',
      donateProject: 'Aeldrune support page coming later',
    },
    entryGuard: {
    ...
    serverUnavailable: {
      ...
      body: 'We are restarting the game service and expect Aelvarin to return shortly. This page will keep checking automatically.',
      status: 'Back soon',
    },
  },
  es: {
    ...
    serverUnavailable: {
      ...
      body: 'Estamos reiniciando el servicio del juego y esperamos que Aelvarin vuelva pronto. Esta página seguirá comprobándolo automáticamente.',
  ...
  fr_FR: {
    ...
    serverUnavailable: {
      ...
      body: 'Nous redémarrons le service de jeu et Aelvarin devrait revenir bientôt. Cette page continuera de vérifier automatiquement.',
  ...
  fr_CA: {
    ...
    serverUnavailable: {
      ...
      eyebrow: 'Maintenance du royaume',
      heading: 'Le royaume est temporairement indisponible.',
      body: 'Nous redémarrons le service de jeu et Aelvarin devrait revenir sous peu. Cette page continuera de vérifier automatiquement.',
  ...
  it_IT: {
    ...
    serverUnavailable: {
      ...
      body: 'Stiamo riavviando il servizio di gioco e prevediamo che Aelvarin torni a breve. Questa pagina continuerà a controllare automaticamente.',
      status: 'Torna presto',
    },
  },
  de_DE: {
    ...
    serverUnavailable: {
      ...
      body: 'Wir starten den Spieldienst neu und erwarten, dass Aelvarin bald zurückkehrt. Diese Seite prüft automatisch weiter.',
      status: 'Bald zurück',
    },
  },
  zh_CN: {
  ...
  pt_BR: {
    ...
    serverUnavailable: {
      ...
      body: 'Estamos reiniciando o serviço do jogo e esperamos que Aelvarin volte em breve. Esta página continuará verificando automaticamente.',
  ...
  ru_RU: {
    ...
    serverUnavailable: {
      ...
      body: 'Мы перезапускаем игровой сервис и ожидаем, что Aelvarin скоро вернется. Эта страница продолжит проверку автоматически.',
