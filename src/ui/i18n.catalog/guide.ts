...
export const guideStrings = {
  ...
  footer: {
    blurb:
      'Aeldrune is a persistent 3D browser MMORPG built around campaign progression, combat, collection, crafting and exploration.',
    playNow: 'Play Now',
    github: 'GitHub (coming later)',
    discord: 'Community (coming later)',
  ...
  aeldrune: {
    nav: {
      systems: 'Training & Collections',
      companions: 'Spirits & Mounts',
    },
    home: {
      eyebrow: 'THE WORLD OF AELVARIN',
      title: 'Aeldrune',
      lead: 'A persistent 3D browser MMORPG with five classes, a 20-region campaign and long-term progression built for exploration and grind.',
      play: 'Enter the game',
      learn: 'Start with the basics',
      facts: 'Current game content',
      factClasses: 'Playable classes',
      factMaps: 'Campaign regions',
      factQuests: 'Authored quests',
      factCap: 'Current level cap',
      journey: 'A campaign that crosses a living world',
      journeyBody:
        'The main campaign travels through twenty regions from level 1 to 200. Side quests, repeatable objectives, open dungeons and resource areas create reasons to leave the direct story path.',
      systems: 'Build a character over time',
      systemsBody:
        'Class-specific equipment, skill ranks, Codex collections, spirits, mounts, crafting and training all feed the same character progression. The wiki describes only systems that exist in the current game data.',
    },
    how: {
      title: 'How to Play',
      lead: 'Create a character, follow the campaign tracker and learn each system as the early quests introduce it.',
      start: 'Your first session',
      startBody:
        'Choose one of the five classes, create a character and enter Vila do Vau. New characters begin with health and mana potions. The first quests introduce movement, combat, interaction, equipment and the utility merchant.',
      mission: 'Auto-mission and manual intervention',
      missionBody:
        'Clicking a tracked quest can move the character through its current objective. Dialogue waits long enough to be read and can be skipped. Collection objectives take five uninterrupted seconds; incoming damage resets the action, so dangerous areas still require player intervention.',
      battle: 'Combat tools',
      battleBody:
        'Single-target attack keeps fighting only the selected enemy. Auto-battle searches for nearby enemies until switched off. Auto skill dots let individual skills join either mode, while auto retaliation answers enemies that attack first.',
      grow: 'Keep your power current',
      growBody:
        'Equip class-specific rewards, improve skills with knowledge tomes, use potions and upgrade the systems introduced by the campaign. Main quests remain available until their recommended combat strength becomes the real obstacle.',
    },
    classes: {
      title: 'Classes',
    ...
    world: {
      title: 'World',
      lead: 'The Aeldrune campaign spans twenty ordered regions with distinct level bands, environments, settlements, routes and danger profiles.',
      route: 'Campaign route',
      routeBody:
        'Portals connect the campaign path, but their safety radius excludes monster spawns and nearby obstructing structures. Open terrain uses physical boundaries that match what the player can see instead of invisible walls across apparently walkable ground.',
    ...
    quests: {
      title: 'Quests',
      lead: 'The current quest catalog contains the complete main campaign plus side, repeatable, city and profession objectives.',
      catalog: 'Quest catalog',
      campaign: 'Campaign structure',
      campaignBody:
        'The main quest is the uninterrupted narrative spine. NPC dialogue carries the story before automation resumes. Side quests use the same route and objective system, while repeatables support grinding and resource loops.',
      objectives: 'Objective clarity',
      objectivesBody:
        'Talk objectives name the actual NPC. Collection objectives place several physical objects across a search radius and mark that area on both the minimap and the full map. Escort routes stay on traversable ground.',
      groupMain: 'Main campaign',
      groupSide: 'Side quests',
      groupRepeatable: 'Repeatable quests',
      groupCityProfession: 'City and profession quests',
    },
    gear: {
      title: 'Gear & Items',
      lead: 'Equipment is class-specific and progresses through six authored ranks across weapons, armor and accessories.',
      inventory: 'Inventory rules',
      inventoryBody:
        'The bag shows only items the character owns. Equipable items clearly show when they are not equipped. Monster loot enters the bag automatically, while a separate reward alert keeps loot readable without covering combat experience feedback.',
      progression: 'Equipment progression',
      progressionBody:
        'Character level does not grant equipment rarity. Every Common through Mythic item is crafted for one class and slot. Starter equipment remains separate and can be replaced by the village provisioner.',
      rankTitle: '{rarity} equipment',
      rankMeta: '{metalCount} {metal} + {darksteel} Darksteel',
      campaignGate: 'Campaign progress does not grant equipment tiers.',
      commonRequirement: 'Common equipment has no previous-item requirement.',
      previousItemRequirement:
        'Consumes the previous rarity item for the same class and equipment slot.',
      metalConversion: 'Metal conversion',
      metalConversionBody:
        'Craft one metal of the next rarity from ten metals of the previous rarity. This conversion continues from Common through Mythic.',
      miningSources: 'Mining sources',
      miningSourcesBody:
        'Equipment metals come from physical ore veins on the world map. Early campaign regions yield lower rarities; progressively later regions introduce Rare, Epic, Legendary and Mythic metals.',
      miningBands: 'Metal distribution by campaign map',
      miningBandTitle: 'Maps {first}-{last}',
      miningBandBody: 'Ore veins yield: {metals}.',
      codex: 'Codex collections',
      codexBody:
        'The Codex unlocks at level {level}. Registering eligible items completes permanent collection milestones and grants different character statistics instead of acting as storage.',
    },
    systems: {
      title: 'Training & Collections',
      lead: 'Aeldrune separates its long-term progression systems so each can be understood, upgraded and balanced independently.',
      training: 'Training',
      trainingBody:
        'Constitution and Inner Force consume energy together with crafted and gathered materials. Higher stages require plants and resources of the correct rarity, tying training to herbalism, hunting, crafting and map gathering areas.',
      crafting: 'Crafting and knowledge tomes',
      craftingBody:
        'Five monster-dropped knowledge fragments craft one Common Tome. Ten Common Tomes craft a Rare Tome, ten Rare craft an Epic, and ten Epic craft a Legendary Tome. Those tiers support skill ranks 1-3, 4-6, 7-9 and 10-15.',
      gathering: 'Gathering areas',
      gatheringBody:
        'Herbs, Darksteel and other materials come from physical resource areas in the world. Gathering takes time and can be interrupted by damage, so resource routes remain part of combat and exploration rather than a menu-only economy.',
      codex: 'Permanent collections',
      codexBody:
        'Equipment Codex, spirit album and mount album track newly confirmed entries and grant incremental statistics until their collections are complete.',
    },
    companions: {
      title: 'Spirits & Mounts',
      lead: 'Spirits and mounts use parallel summon, confirmation, collection and fusion systems with separate tickets and catalogs.',
      spirits: 'Spirits',
      spiritsBody:
        'The current catalog contains {count} spirits across six grades. Confirmed spirits fill the album and add collection statistics. Duplicate confirmed copies can be combined by grade.',
      mounts: 'Mounts',
      mountsBody:
        'The current catalog contains {count} mounts. An equipped mount grants passive combat bonuses even while dismounted, and mounting increases travel speed according to grade.',
      gradeCount: '{count} grades',
      summon: 'Summon and fusion',
      summonBody:
        'The sanctuary supports single, 10-ticket and 100-ticket summons when enough tickets are available. Results wait in a dedicated confirmation area before they enter the collection or become fusion material.',
    },
    dungeons: {
      title: 'Dungeons',
      lead: 'Aeldrune has two clear dungeon families: open world-linked dungeons and limited ticket dungeons.',
      open: 'Open dungeons',
      openBody:
        'Open dungeons are reached through animated world portals and do not consume tickets. They are repeatable combat and grind spaces integrated with exploration.',
      ticketed: 'Ticket dungeons',
      ticketedBody:
        'Ticket dungeons consume {cost} ticket per entry, hold up to {cap} entries and reset daily at {hour}:00. The current catalog has six tiers for five-player groups, starting at level 20.',
      recommended: 'Recommended power {power}',
      ticketName: 'Ticket Expedition {tier}',
      ticketMeta: 'Level {level} · {players} players',
    },
    combat: {
      title: 'Combat',
      lead: 'Combat separates deliberate single-target attacks from autonomous hunting while preserving optional per-skill automation.',
      target: 'Single-target attack',
      targetBody:
        'Select an enemy and use the basic attack command to keep attacking only that target. When it dies, the character stops instead of searching for a replacement.',
      auto: 'Auto-battle',
      autoBody:
        'Auto-battle is a tool, not a skill. When enabled it looks for valid monsters inside a nearby radius, approaches them, faces the target and continues finding enemies until disabled.',
      skills: 'Automatic skills',
      skillsBody:
        'Each action-bar skill has its own automation toggle. Enabled skills can be used during single-target combat or auto-battle only when the target is in the skill range and all costs and cooldowns are valid.',
      recovery: 'Potions and retaliation',
      recoveryBody:
        'Health and mana potion thresholds are configurable from the action bar. Auto retaliation answers hostile attacks even when auto-battle is off, without turning one defensive response into endless target searching.',
    },
    controls: {
      title: 'Controls',
      lead: 'Mouse camera is the only camera mode. The controls below reflect the current playable client.',
      movement: 'Movement and camera',
      movementBody:
        'Use W, A, S and D to move. Hold the mouse camera control to rotate the view and use the wheel to adjust distance. Camera motion stays independent from the character walk animation.',
      panels: 'Main panels',
      panelsBody:
        'M opens the full map. Character, bag, skills, crafting, training, Codex, spirits and mounts are separate systems in the side menu. Escape closes the topmost panel.',
      action: 'Action bar',
      actionBody:
        'The lower action bar holds skills, health and mana potions, auto-battle and auto-gather tools. Skill automation dots are independent from the auto-battle switch.',
    },
    faq: {
      ...
      a3: 'Auto-mission handles travel and eligible objectives, but dialogue, dangerous collection areas, combat-power walls and selected challenges still require player attention.',
      q4: 'Are dungeons always limited by tickets?',
      a4: 'No. World-linked open dungeons are free to enter. A separate set of premium instances consumes daily tickets.',
      q5: 'Where do I buy potions?',
      a5: 'Sara das Ervas is the early utility merchant. New characters also begin with 50 health potions and 50 mana potions, and each potion stack can hold up to 5,000.',
      q6: 'Does Aeldrune have official social channels?',
      a6: 'Not yet. Social and source links remain disabled until official Aeldrune channels are published.',
    },
  },
  ...
  home: {
    ...
    what: {
      ...
      pillarBuildsBody:
        'Equipment, skills, spirits, mounts, Codex and training all shape your character. Every choice can support a different combat build.',
    },
    ...
    faq: {
      ...
      aAccess:
        'Create an account and play in the browser, or install the private Aeldrune Windows client from the official download page.',
