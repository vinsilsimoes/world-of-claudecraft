  ...
  entities: {
    abilities: abilityTranslations([
      ...
      [
        'mir4_skill_1103',
        'Barbaric Charge',
        'Charge to the target and strike up to 10 enemies within 6 yards of you twice for {damage} total damage. The first hit pushes them to the impact point. The final hit knocks them down for 3 sec.',
      ],
      [
        'mir4_skill_1104',
        'Splitting Slash',
        'Advance 3 yards and strike up to 8 enemies in a 7-yard-long, 5.5-yard-wide frontal strip for {damage} damage. Each enemy hit is knocked down for 3 sec.',
      ],
      [
        'mir4_skill_1201',
        'Iron Shackle',
      ...
      [
        'mir4_skill_1304',
        'Body Check',
        'Deals {damage} damage to an enemy. Up to 7 other enemies in an 8-yard-long, 5-yard-wide frontal strip take 100% damage. Charges to the target. Knocks each enemy hit down for 3 sec.',
      ],
      [
        'mir4_skill_1401',
        'Ground Smash',
      ...
      [
        'mir4_skill_1501',
        'Gale Slash',
        'Strike enemies around you 9 times for {damage} total damage. You are immune to control effects for 2 sec. Each contact reduces the Physical Defense of enemies hit by 25% for 5 sec.',
      ],
      [
        'mir4_skill_1502',
        'Unbreakable Stance',
      ...
      [
        'mir4_skill_2101',
        'Flame Orb',
        'Launches a projectile at the selected enemy, dealing {damage} Spell damage on contact and Knocking it Back slightly.',
      ],
      [
        'mir4_skill_2111',
        'Frost Orb',
        'Launches a projectile at the selected enemy, dealing {damage} Spell damage on contact and causing a brief hit reaction.',
      ],
      [
        'mir4_skill_2501',
        'Dark Vortex',
      ...
      [
        'mir4_skill_2503',
        'Magic Shield',
        'Strikes up to 8 enemies in three expanding circles around you for {damage} total Spell damage, knocking them back. Creates a Magic Shield for 25 sec, reducing all damage taken by 24%. It disappears after preventing 2000 damage or taking 20 hits. Bash Damage Reduction is increased by 15%.',
      ],
      [
        'mir4_skill_2203',
        'Blizzard',
      ...
      [
        'mir4_ultimate_1',
        'Dragon Flame',
        'Deals {damage} Physical damage over 4 contacts. Grants Invincibility for 3 sec. Requires a full Ultimate gauge.',
      ],
      [
        'mir4_ultimate_2',
        'Dragon Tornado',
        'Creates a fixed 7-yard tornado that strikes up to 10 enemies at each of 10 contacts for {damage} total Spell damage. The first 5 contacts can Knock Back and the sixth can Knock Down, each with a 10% chance. Grants Invincibility for 3 sec. Requires a full Ultimate gauge.',
      ],
      [
        'mir4_ultimate_3',
        'Ray of Light',
