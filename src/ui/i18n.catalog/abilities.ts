  ...
  entities: {
    abilities: abilityTranslations([
      ...
      [
        'mir4_skill_1101',
        'Berserk',
        'Deals {damage} damage to an enemy. Up to 7 other enemies within 7 yards of you take 100% damage. Increases your damage by 12% for 15 sec.',
      ],
      [
        'mir4_skill_1102',
        'Void Slash',
      ...
      [
        'mir4_skill_1103',
        'Barbaric Charge',
        'Charges to the target and deals {damage} damage. Up to 7 other enemies within 7 yards of you take 100% damage. Pulls nearby enemies toward you and knocks each enemy hit down for 1.2 sec. Increases your Physical and Magic Defense by 12% for 6 sec.',
      ],
      [
        'mir4_skill_1104',
        'Splitting Slash',
      ...
      [
        'mir4_skill_1201',
        'Iron Shackle',
        'Deals {damage} damage to an enemy. Up to 4 other enemies within 10 yards of a point 5 yards in front of you take 100% damage and are pulled toward you.',
      ],
      [
        'mir4_skill_1301',
        'Riposte',
        'Deals {damage} damage to an enemy. Increases your Physical and Magic Defense by 24% for 3 sec. At rank 8, restores 10% of your maximum health; at rank 10, restores 20%.',
      ],
      [
        'mir4_skill_1302',
        "Lion's Roar",
        'Deals {damage} damage to an enemy. Up to 7 other enemies within 7 yards of you take 100% damage.',
      ],
      [
        'mir4_skill_1304',
        'Body Check',
      ...
      [
        'mir4_skill_1401',
        'Ground Smash',
        'Deals {damage} damage to an enemy. Up to 3 other enemies within 7 yards of a point 6 yards in front of you take 70% damage. Knocks the target down for 0.8 sec.',
      ],
      [
        'mir4_skill_1501',
        'Gale Slash',
        'Deals {damage} damage to an enemy. Up to 4 other enemies within 7.75 yards of you take 65% damage. Slows each enemy hit by 35% for 3.2 sec.',
      ],
      [
        'mir4_skill_1502',
        'Unbreakable Stance',
        'Deals {damage} damage to up to 8 nearby enemies. At rank 8, increases your Dodge by 30; at rank 10, by 60 for 20 sec.',
      ],
      [
        'mir4_skill_1601',
        'Crescent Strike',
        'Deals {damage} damage to an enemy. Up to 4 other enemies in a 9-yard-long, 5-yard-wide frontal strip take 85% damage.',
      ],
      [
        'mir4_skill_2101',
        'Flame Orb',
        'Deals {damage} damage to an enemy. Up to 3 other enemies within 6.5 yards take 65% damage. Burns each enemy hit for {burnPerTick} base damage every 1 sec (4 ticks, {burnTotal} total before mitigation). Damage is based on your Spell Power when the Burn is applied.',
      ],
      [
        'mir4_skill_2111',
        'Frost Orb',
        'Deals {damage} damage to an enemy. Up to 3 other enemies within 6.5 yards take 65% damage. Slows each enemy hit by 35% for 3.2 sec.',
      ],
      [
        'mir4_skill_2501',
        'Dark Vortex',
        'Deals {damage} damage to an enemy. Pulls up to 4 other enemies within 8 yards toward you and roots each enemy hit for 2.2 sec.',
      ],
      [
        'mir4_skill_2301',
        'Thunderstorm',
        'Deals {damage} damage to an enemy. Up to 4 other enemies within 7 yards take 65% damage. Dazes each enemy hit for 1.2 sec.',
      ],
      ['mir4_skill_2503', 'Magic Shield', 'Reduces damage taken by 22% for 10 sec.'],
      [
        'mir4_skill_2203',
        'Blizzard',
        'Deals {damage} damage over 7 impacts. Up to 7 other enemies within 9 yards take full damage. Freezes each enemy hit for 1.8 sec.',
      ],
      [
        'mir4_skill_2303',
        'Chain Lightning',
        'Deals {damage} damage to an enemy and chains at full damage to up to 6 other enemies within 12 yards.',
      ],
      [
        'mir4_skill_2201',
        'Flame Strike',
        'Deals {damage} damage over 3 impacts to nearby enemies. Pushes each enemy hit 5.5 yards away and dazes them for 0.9 sec.',
      ],
      [
        'mir4_skill_2502',
        'Soul Devour',
        'Deals {damage} damage over 5 impacts. Up to 5 other enemies within 7 yards take full damage.',
      ],
      [
        'mir4_skill_2103',
        'Immolate',
        'Deals {damage} damage over 10 impacts. Up to 4 other enemies within 10 yards take 75% damage. Burns each enemy hit for {burnPerTick} base damage every 1 sec (6 ticks, {burnTotal} total before mitigation).',
      ],
      ['mir4_skill_2204', 'Phoenix Embrace', 'Increases your damage by 25% for 60 sec.'],
      [
        'mir4_skill_2202',
        'Frozen Block',
        'Deals {damage} damage over 3 impacts to nearby enemies and freezes them for 2 sec. Reduces damage taken by 100% for 4 sec.',
      ],
      [
        'mir4_skill_3506',
        'Moonlight Wave',
        'Deals {damage} damage over 5 impacts. Up to 3 other enemies within 7 yards take 60% damage. Slows each enemy hit by 25% for 8 sec.',
      ],
      [
        'mir4_skill_3101',
        'Sunbeam Sword',
      ...
      [
        'mir4_skill_3301',
        'Moonlight Orb',
        'Deals {damage} damage over 9 impacts. Up to 3 other enemies within 7.25 yards take 60% damage. Roots each enemy hit for 1.6 sec.',
      ],
      [
        'mir4_skill_3104',
        'Rain of Blades',
        'Deals {damage} hybrid damage over 4 impacts. Up to 4 other enemies within 7.75 yards take 60% damage. At rank 8, each enemy hit has a 40% chance to be Silenced for 4 sec.',
      ],
      [
        'mir4_skill_3503',
        'Heal',
        'Restores 18% of maximum health to you and up to 4 party members within 20 yards.',
      ],
      [
        'mir4_skill_3103',
        'Piercing Blades',
        'Deals {damage} damage to an enemy. Up to 3 other enemies within 6.5 yards take 65% damage. From rank 5, Stuns monsters for 2 sec and has a 20% base chance to Stun players.',
      ],
      [
        'mir4_skill_3501',
        'Guardian Circle',
        "Deals {damage} damage to nearby enemies and increases the party's Physical and Magic Defense by 25% for 60 sec.",
      ],
      [
        'mir4_skill_3201',
        'Tai Chi',
        'Deals {damage} hybrid damage to nearby enemies, pulls them toward you and Knocks them Down for 1.5 sec. Base Knockdown chance is 100% against monsters and 10% against players.',
      ],
      [
        'mir4_skill_3505',
        'Blasting Charm',
        'Deals {damage} damage to an enemy, reduces its damage by 35% for 8 sec and reduces its Physical and Magic Defense by 12% for 15 sec.',
      ],
      [
        'mir4_skill_3203',
        'Soaring Slash',
        'Deals {damage} hybrid damage over 6 impacts. Up to 3 other enemies within 7 yards take 70% damage and have their Physical and Magic Defense reduced by 12% for 10 sec.',
      ],
      [
        'mir4_skill_3404',
        'Expulsion Circle',
        "Increases the party's Physical and Magic Defense by 25% for 60 sec.",
      ],
      [
        'mir4_skill_3504',
        'Greater Heal',
        'Restores 45% of maximum health to you and up to 4 party members within 20 yards.',
      ],
      [
        'mir4_skill_4101',
        'Quick Shot',
        'Deals {damage} damage over 6 rapid impacts. Up to 3 other enemies within 7 yards take 65% damage.',
      ],
      [
        'mir4_skill_4106',
        'Painstrike Gale',
        'Deals {damage} damage to an enemy. Stuns monsters for 2 sec and has a 10% base chance to Stun players.',
      ],
      [
        'mir4_skill_4102',
        'Illusion Arrow',
        'Deals {damage} damage over 5 impacts. Up to 3 other enemies within 6.625 yards take 65% damage and grants 60 Dodge for 4 sec.',
      ],
      [
        'mir4_skill_4103',
        'Burst Shell',
        'Deals {damage} damage to an enemy. Up to 4 other enemies within 7.5 yards take 65% damage and have their Physical and Magic Defense reduced by 12% for 10 sec.',
      ],
      [
        'mir4_skill_4107',
        'Flash Arrow',
        'Deals {damage} damage to an enemy. Up to 3 other enemies within 6.75 yards take 60% damage and have their damage reduced by 45% for 5 sec.',
      ],
      [
        'mir4_skill_4108',
        'Heavenly Bow',
        'Deals {damage} damage in an arrow rain. Up to 7 other enemies within 9 yards take 85% damage.',
      ],
      ['mir4_skill_4111', "Mind's Eye", 'Increases your damage by 15% for 30 sec.'],
      ['mir4_skill_4105', 'Ice Cage', 'Deals {damage} damage and slows enemies by 50% for 10 sec.'],
      [
        'mir4_skill_4109',
        'Obliterate Shell',
        'Deals {damage} damage and Knocks Down monsters for 1.4 sec; base chance against players is 10%.',
      ],
      [
        'mir4_skill_4104',
        'Venom Mist Shell',
        'Deals {damage} damage in a poisonous area and reduces enemy damage by 40% for 5 sec.',
      ],
      [
        'mir4_skill_4110',
        'Seeking Bolt',
        'Deals {damage} damage to a single enemy from extreme range.',
      ],
      [
        'mir4_skill_4112',
        'Cloaking',
        'Grants 150 Dodge and increases your damage by 20% for 2 sec.',
      ],
      [
        'mir4_skill_5201',
        'Ravaging Blow',
        'Deals {damage} hybrid damage over 6 impacts and slows enemies by 25% for 5 sec.',
      ],
      [
        'mir4_skill_5101',
        'Crescent Blade',
        'Deals {damage} damage and Knocks Down monsters for 1 sec; base chance against players is 10%.',
      ],
      [
        'mir4_skill_5104',
        'Nirvana Kick',
      ...
      [
        'mir4_skill_5301',
        'Double Strike',
        'Deals {damage} damage to an enemy. Up to 3 other enemies within 7.25 yards take 70% damage.',
      ],
      [
        'mir4_skill_5401',
        'Sweeping Storm',
        'Deals {damage} hybrid damage and reduces enemy damage by 30% for 5 sec.',
      ],
      ['mir4_skill_5102', 'Dragon Tail', 'Deals {damage} damage to enemies swept by the spear.'],
      [
        'mir4_skill_5103',
        'Ascending Dragon',
        'Deals {damage} hybrid damage and slows enemies by 30% for 5 sec.',
      ],
      [
        'mir4_skill_5303',
        'Crushing Blow',
      ...
      [
        'mir4_skill_5403',
        'Wind Wall',
        'Deals {damage} hybrid damage and increases your Physical and Magic Defense by 20% for 5 sec.',
      ],
      [
        'mir4_skill_5205',
        'Piercing Spear',
        'Deals {damage} hybrid damage from long range and Knocks Down monsters for 1.6 sec; base chance against players is 10%.',
      ],
      [
        'mir4_skill_5304',
        'Absorption',
        'Deals {damage} damage and restores 15% of your maximum health.',
      ],
      [
        'mir4_skill_5202',
        'Blitz Strike',
        'Charges a distant enemy, deals {damage} damage and Knocks it Down.',
      ],
      [
        'mir4_ultimate_1',
        'Dragon Flame',
        'Deals {damage} damage over 3 impacts. Restores 10% of your maximum health. Requires a full Ultimate gauge.',
      ],
      [
        'mir4_ultimate_2',
        'Dragon Tornado',
