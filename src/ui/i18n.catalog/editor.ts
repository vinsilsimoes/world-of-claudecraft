...
export const editorStrings = {
  ...
  questEditor: {
    ...
    close: 'Close',
    intro:
      'Select a mission stage, review every objective point, then place each point directly on the 3D or 2D map.',
    map: 'Campaign map',
    quest: 'Mission',
    stage: 'Stage',
    interactionStage: 'Interaction stage: these points spawn collectable or activatable objects.',
    navigationStage:
      'Navigation stage: this point controls travel, dialogue, or encounter routing.',
