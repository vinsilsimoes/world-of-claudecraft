...
// The four non-Warrior Aeldrune classes use their own code-native compositions.
// These recipes deliberately name the MIR4 action ids directly: the WoC paintings
// remain available to the classic profile, but are never used as MIR4 aliases.
const MIR4_CLASS_ABILITY_RECIPES: Record<string, IconRecipe> = {
  // Sorcerer — fire, frost, lightning and arcane control.
  mir4_skill_2101: r(
    'fire',
    'ember',
    ['meteor', { p: 'tendrils', ...BR, pal: 'arcanePink' }],
    ['glow', 'motion'],
  ),
  mir4_skill_2111: r(
    'frost',
    'ice',
    ['snowflake', { p: 'shield', ...BR, pal: 'silverWhite' }],
    ['glow'],
  ),
  mir4_skill_2501: r(
    'arcane',
    'arcanePink',
    ['moon', { p: 'tendrils', ...BIG, pal: 'shadowPurple' }],
    ['arcs'],
  ),
  mir4_skill_2301: r(
    'storm',
    'sky',
    ['lightning', { p: 'bolt', ...BR, pal: 'silverWhite' }],
    ['glow', 'motion'],
  ),
  mir4_skill_2503: r(
    'frost',
    'silverWhite',
    ['shield', { p: 'snowflake', ...TR, pal: 'ice' }],
    ['arcs'],
  ),
  mir4_skill_2203: r(
    'frost',
    'ice',
    [
      { p: 'snowflake', x: -11, y: -10, s: 0.55 },
      { p: 'snowflake', x: 10, y: 8, s: 0.78 },
    ],
    ['motion'],
  ),
  mir4_skill_2303: r(
    ...
    'sky',
    [
      { p: 'lightning', x: -8, s: 0.72 },
      { p: 'lightning', x: 9, s: 0.82, rot: 0.35 },
    ],
    ['arcs'],
  ),
  mir4_skill_2201: r(
    'fire',
    'ember',
    ['flame', { p: 'sunburst', ...BIG, pal: 'gold' }],
    ['crack', 'glow'],
  ),
  mir4_skill_2502: r(
    'arcane',
    'arcanePink',
    ['bolt', { p: 'sigil_rune', ...BR, pal: 'silverWhite' }],
    ['motion', 'sparkle'],
  ),
  mir4_skill_2103: r(
    'fire',
    'ember',
    ['meteor', { p: 'flame', ...BR, pal: 'gold' }],
    ['drips', 'glow'],
  ),
  mir4_skill_2204: r(
    'fire',
    'gold',
    ['wing', { p: 'flame', ...BR, pal: 'ember' }],
    ['glow', 'sparkle'],
  ),
  mir4_skill_2202: r(
    'frost',
    'ice',
    ['shield', { p: 'snowflake', ...BIG, pal: 'silverWhite' }],
    ['arcs', 'glow'],
  ),
  mir4_ultimate_2: r(
    'fire',
    'gold',
    ['meteor', { p: 'sunburst', ...BIG, pal: 'ember' }],
    ['glow', 'motion', 'sparkle'],
  ),

  // Taoist — lunar blades, talismans, wind and restoration.
  mir4_skill_3506: r(
    'storm',
    'silverWhite',
    ['moon', { p: 'bolt', ...BR, pal: 'sky' }],
    ['motion', 'arcs'],
  ),
  mir4_skill_3101: r(
    'holy',
    'gold',
    ['sword', { p: 'sunburst', ...TR, pal: 'holyGold' }],
    ['glow'],
  ),
  mir4_skill_3301: r(
    'arcane',
    'silverWhite',
    ['moon', { p: 'sigil_rune', ...BR, pal: 'arcanePink' }],
    ['arcs', 'sparkle'],
  ),
  mir4_skill_3104: r(
    'storm',
  ...
  mir4_skill_3103: r(
    ...
    [
      { p: 'sword', x: -8, s: 0.78 },
      { p: 'sword', x: 8, s: 0.78, rot: Math.PI },
    ],
    ['motion', 'arcs'],
  ),
  mir4_skill_3501: r(
    'holy',
    'holyGold',
    ['shield', { p: 'moon', ...BIG, pal: 'silverWhite' }],
    ['glow', 'arcs'],
  ),
  mir4_skill_3201: r(
    'storm',
    'silverWhite',
    ['tendrils', { p: 'moon', ...BR, pal: 'sky' }],
    ['arcs', 'motion'],
  ),
  mir4_skill_3505: r(
    'fire',
    'ember',
    ['sigil_rune', { p: 'flame', ...BR, pal: 'gold' }],
    ['glow', 'crack'],
  ),
  mir4_skill_3203: r(
    'storm',
    'sky',
    ['sword', { p: 'wing', ...BR, pal: 'silverWhite' }],
    ['motion', 'arcs'],
  ),
  mir4_skill_3404: r(
    'holy',
    'silverWhite',
    ['sunburst', { p: 'tendrils', ...BIG, pal: 'sky' }],
    ['arcs', 'sparkle'],
  ),
  mir4_skill_3504: r(
    'holy',
    'holyGold',
    ['heart', { p: 'moon', ...TR, pal: 'silverWhite' }],
    ['glow', 'sparkle'],
  ),
  mir4_ultimate_3: r(
    'storm',
    'holyGold',
    ['moon', { p: 'sunburst', ...BIG, pal: 'sky' }],
    ['glow', 'arcs', 'sparkle'],
  ),

  // Arbalist — precise bolts, traps, bombardment and concealment.
  mir4_skill_4101: r('storm', 'steel', ['bow', { p: 'arrow', ...BR, pal: 'gold' }], ['motion']),
  mir4_skill_4106: r(
    'blood',
    'blood',
    ['crosshair', { p: 'arrow', ...BR, pal: 'silverWhite' }],
    ['motion', 'glow'],
  ),
  mir4_skill_4102: r(
    'arcane',
    'arcanePink',
    ['eye', { p: 'arrow', ...BR, pal: 'sky' }],
    ['sparkle', 'motion'],
  ),
  mir4_skill_4103: r(
    'fire',
    'ember',
    ['shield', { p: 'arrow', ...TR, pal: 'gold' }],
    ['crack', 'glow'],
  ),
  mir4_skill_4107: r(
    'holy',
    'holyGold',
    ['sunburst', { p: 'arrow', ...BR, pal: 'silverWhite' }],
    ['glow', 'motion'],
  ),
  mir4_skill_4108: r(
    'storm',
    'sky',
    [
      { p: 'arrow', x: -11, y: -10, s: 0.58 },
      { p: 'arrow', s: 0.7 },
      { p: 'arrow', x: 11, y: 10, s: 0.82 },
    ],
    ['motion'],
  ),
  mir4_skill_4111: r(
    'arcane',
    'gold',
    ['eye', { p: 'crosshair', ...BIG, pal: 'sky' }],
    ['sparkle'],
  ),
  mir4_skill_4105: r(
    'frost',
    'ice',
    ['tendrils', { p: 'snowflake', ...BR, pal: 'silverWhite' }],
    ['arcs', 'glow'],
  ),
  mir4_skill_4109: r(
    'fury',
    'blood',
    ['shield', { p: 'sunburst', ...BIG, pal: 'ember' }],
    ['crack', 'motion'],
  ),
  mir4_skill_4104: r(
    'nature',
    'venom',
    ['droplet', { p: 'shield', ...BR, pal: 'steel' }],
    ['drips', 'glow'],
  ),
  mir4_skill_4110: r(
    'treasure',
  ...
  mir4_skill_4112: r(
    'shadow',
    'shadowPurple',
    ['eye', { p: 'moon', ...BIG, pal: 'silverWhite' }],
    ['motion', 'sparkle'],
  ),
  mir4_ultimate_4: r(
    'storm',
    'gold',
    ['bow', { p: 'sunburst', ...BIG, pal: 'holyGold' }],
    ['motion', 'glow', 'sparkle'],
  ),

  // Lancer — spear-like thrusts, crescents, dragons and wind control.
  mir4_skill_5201: r(
    'steel',
    'silverWhite',
    ['sword', { p: 'lightning', ...BR, pal: 'sky' }],
    ['motion', 'crack'],
  ),
  mir4_skill_5101: r(
    'storm',
    'sky',
    ['moon', { p: 'sword', ...BR, pal: 'silverWhite' }],
    ['arcs', 'motion'],
  ),
  mir4_skill_5104: r(
    'fury',
    'gold',
    ['boot', { p: 'sunburst', ...BR, pal: 'ember' }],
    ['crack', 'motion'],
  ),
  mir4_skill_5301: r(
    'steel',
  ...
  mir4_skill_5401: r(
    'storm',
    'sky',
    ['tendrils', { p: 'sword', ...BR, pal: 'gold' }],
    ['arcs', 'glow'],
  ),
  mir4_skill_5102: r(
    'fury',
    'ember',
    ['claw_slash', { p: 'sword', ...BR, pal: 'gold' }],
    ['motion', 'glow'],
  ),
  mir4_skill_5103: r(
    'storm',
    'gold',
    ['wing', { p: 'lightning', ...BR, pal: 'sky' }],
    ['arcs', 'motion'],
  ),
  mir4_skill_5303: r(
    'earth',
    'earthBrown',
    ['fist', { p: 'sword', ...BR, pal: 'silverWhite' }],
    ['crack'],
  ),
  mir4_skill_5403: r(
    'storm',
    'silverWhite',
    ['shield', { p: 'tendrils', ...BIG, pal: 'sky' }],
    ['arcs', 'motion'],
  ),
  mir4_skill_5205: r(
    'steel',
    'gold',
    ['crosshair', { p: 'sword', ...BR, pal: 'silverWhite' }],
    ['motion', 'glow'],
  ),
  mir4_skill_5304: r(
    'shadow',
    'arcanePink',
    ['droplet', { p: 'heart', ...BR, pal: 'blood' }],
    ['drips', 'glow'],
  ),
  mir4_skill_5202: r(
    'storm',
    'sky',
    ['lightning', { p: 'sword', ...BR, pal: 'gold' }],
    ['motion', 'glow'],
  ),
  mir4_ultimate_5: r(
    'storm',
    'gold',
    ['wing', { p: 'lightning', ...BIG, pal: 'sky' }, { p: 'sword', ...BR, pal: 'silverWhite' }],
    ['arcs', 'motion', 'glow'],
  ),
};

const ABILITY_RECIPES: Record<string, IconRecipe> = {
  mir4_skill_2101: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_2101,
  mir4_skill_2111: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_2111,
  mir4_skill_2501: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_2501,
  mir4_skill_2301: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_2301,
  mir4_skill_2503: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_2503,
  mir4_skill_2203: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_2203,
  mir4_skill_2303: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_2303,
  mir4_skill_2201: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_2201,
  mir4_skill_2502: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_2502,
  mir4_skill_2103: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_2103,
  mir4_skill_2204: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_2204,
  mir4_skill_2202: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_2202,
  mir4_ultimate_2: MIR4_CLASS_ABILITY_RECIPES.mir4_ultimate_2,
  mir4_skill_3506: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_3506,
  mir4_skill_3101: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_3101,
  mir4_skill_3301: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_3301,
  mir4_skill_3104: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_3104,
  mir4_skill_3503: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_3503,
  mir4_skill_3103: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_3103,
  mir4_skill_3501: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_3501,
  mir4_skill_3201: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_3201,
  mir4_skill_3505: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_3505,
  mir4_skill_3203: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_3203,
  mir4_skill_3404: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_3404,
  mir4_skill_3504: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_3504,
  mir4_ultimate_3: MIR4_CLASS_ABILITY_RECIPES.mir4_ultimate_3,
  mir4_skill_4101: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_4101,
  mir4_skill_4106: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_4106,
  mir4_skill_4102: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_4102,
  mir4_skill_4103: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_4103,
  mir4_skill_4107: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_4107,
  mir4_skill_4108: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_4108,
  mir4_skill_4111: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_4111,
  mir4_skill_4105: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_4105,
  mir4_skill_4109: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_4109,
  mir4_skill_4104: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_4104,
  mir4_skill_4110: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_4110,
  mir4_skill_4112: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_4112,
  mir4_ultimate_4: MIR4_CLASS_ABILITY_RECIPES.mir4_ultimate_4,
  mir4_skill_5201: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_5201,
  mir4_skill_5101: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_5101,
  mir4_skill_5104: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_5104,
  mir4_skill_5301: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_5301,
  mir4_skill_5401: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_5401,
  mir4_skill_5102: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_5102,
  mir4_skill_5103: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_5103,
  mir4_skill_5303: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_5303,
  mir4_skill_5403: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_5403,
  mir4_skill_5205: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_5205,
  mir4_skill_5304: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_5304,
  mir4_skill_5202: MIR4_CLASS_ABILITY_RECIPES.mir4_skill_5202,
  mir4_ultimate_5: MIR4_CLASS_ABILITY_RECIPES.mir4_ultimate_5,
  ...
  // Aeldrune Warrior. These are original code-native compositions over the
  // runtime icon primitives, never aliases to classic WoC ability paintings.
  mir4_skill_1102: r(
    'shadow',
    'silverWhite',
    ['sword', { p: 'claw_slash', x: 7, y: -5, s: 0.72, pal: 'arcanePink' }],
    ['arcs'],
  ),
  mir4_skill_1302: r(
    'fury',
    'gold',
    ['roar', { p: 'sunburst', ...BIG, pal: 'blood' }],
    ['arcs', 'glow'],
  ),
  mir4_skill_1301: r(
    'steel',
    'silverWhite',
    ['shield', { p: 'sword', x: 8, y: -7, s: 0.72, rot: Math.PI / 2 }],
    ['motion'],
  ),
  mir4_skill_1101: r(
    'blood',
    'blood',
    ['fist', { p: 'flame', x: 0, y: 7, s: 0.72, pal: 'ember' }],
    ['glow', 'arcs'],
  ),
  mir4_skill_1103: r(
    'fury',
    'ember',
    ['boot', { p: 'sword', x: 11, y: -8, s: 0.62, pal: 'steel' }],
    ['motion', 'crack'],
  ),
  mir4_skill_1104: r(
    'blood',
    'silverWhite',
    ['sword', { p: 'droplet', ...BR, pal: 'blood' }],
    ['crack', 'drips'],
  ),
  mir4_skill_1501: r(
    'storm',
    'sky',
    [
      { p: 'sword', x: -8, s: 0.8, rot: -0.7 },
      { p: 'sword', x: 8, s: 0.8, rot: 0.9 },
    ],
    ['arcs', 'motion'],
  ),
  mir4_skill_1201: r(
    'steel',
    'steel',
    ['tendrils', { p: 'fist', ...BR, pal: 'silverWhite' }],
    ['arcs'],
  ),
  mir4_skill_1601: r(
    'storm',
    'gold',
    ['moon', { p: 'sword', x: 8, y: 5, s: 0.72, pal: 'silverWhite' }],
    ['motion', 'glow'],
  ),
  mir4_skill_1304: r(
    'earth',
    'earthBrown',
    ['pauldron', { p: 'sunburst', ...BR, pal: 'gold' }],
    ['motion', 'crack'],
  ),
  mir4_skill_1401: r(
    'earth',
    'earthBrown',
    ['fist', { p: 'sunburst', ...BIG, pal: 'ember' }],
    ['crack'],
  ),
  mir4_skill_1502: r(
    'holy',
    'gold',
    ['shield', { p: 'tendrils', ...BIG, pal: 'steel' }],
    ['glow', 'arcs'],
  ),
  mir4_ultimate_1: r(
    'fire',
    'ember',
    ['flame', { p: 'sword', x: 1, y: -3, s: 0.82, pal: 'gold' }],
    ['glow', 'arcs', 'motion'],
  ),
...
/** The MIR4 profile owns code-native art for every active action. */
