...
export const zh_CN: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "mir4_skill_3503": {
        "name": "玉莲",
        "description": "每秒为自身和30码内最多4名队员恢复{healPerPulse}点生命值，持续5秒（共恢复{healTotal}点）。治疗量随法术强度提高。自身免疫控制效果2秒。5阶时，立即为自身恢复10%最大生命值、为队员恢复15%。8阶时，立即恢复量提升至25%和35%；沉默状态下也可施放，移除沉默，清除自身弱化并有50%概率清除队员的弱化，同时获得10%首领伤害减免，持续30秒。10阶时，立即恢复量提升至40%和50%，必定清除队员的弱化并同时移除眩晕，首领伤害减免提升至20%，持续60秒。"
      },
      "mir4_skill_3103": {
