...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wiki": {
      "confirmTitle": "打开维基？",
      "confirmBody": "将在浏览器中打开 Aeldrune 维基，游戏会继续运行。",
      "confirmOpen": "打开维基",
      "confirmCancel": "取消"
    },
    "unstuck": {
    ...
    "wocStore": {
      ...
      "wallet": {
        "title": "Solana 钱包",
        "unlinked": "连接钱包应用，然后签名一次，将其公开地址绑定到你的 Aeldrune 账号。我们绝不会获取你的恢复短语或私钥。",
        "connectedUnlinked": "钱包应用已连接到此浏览器，但其公开地址尚未绑定到你的 Aeldrune 账号。",
    ...
    "mir4": {
      ...
      "equipmentVisualShell": "采用 Aeldrune 外观与 MIR4 战斗属性",
      ...
      "mountTicketDawnDescription": "召唤一个坐骑：79% 普通、20% 优秀或 1% 稀有。成功召唤时会消耗召唤券。显示的模型采用 Aeldrune 原生外观；列出的 MIR4 属性为权威数据。",
      "mountTicketTwilightDescription": "召唤一个坐骑：99% 稀有或 1% 史诗。史诗结果在确认后才归玩家所有。显示的模型采用 Aeldrune 原生外观。",
      ...
      "mountOwned": "拥有：{count}",
      "mountEquipped": "已装备",
      "mountEquipHint": "点击装备此坐骑并召唤其 Aeldrune 原生外观。",
      "mountUnequipHint": "点击卸下此坐骑并下坐骑。",
      "mountConfirmHint": "点击确认此坐骑并将其加入收藏。",
      "mountConfirmAria": "确认 {mount}",
      "mountEffectShell": "采用 Aeldrune 原生模型与 MIR4 坐骑属性",
      ...
      "spiritTicketDawnDescription": "召唤一个精灵：79% 普通、20% 优秀或 1% 稀有。成功召唤时会消耗召唤券。图标采用 Aeldrune 原生表现；只有列出的 MIR4 效果生效。",
      ...
      "spiritEffectShell": "采用 Aeldrune 原生表现与 MIR4 精灵效果",
      ...
      "stats": {
        ...
        "healthPotionEffect": "生命药水效果",
        "manaPotionEffect": "法力药水效果",
        "skillCooldown": "Skill Cooldown Reduction",
        "mpCostReduction": "MP Cost Reduction",
        "basicAttackDamage": "普通攻击伤害",
        "basicDamageReduction": "普通攻击伤害减免",
        ...
        "penetration": "防御穿透",
        "penetrationProtection": "防御穿透防护",
        "unknown": "战斗属性"
      },
      "skillCooldownDisclosure": "上方显示的是基础冷却时间。技能冷却缩减在 PvE 中最多可降低 40%，在 PvP 中最多可降低 30%。",
      "materials": {
    ...
    "nativeUpdate": {
      "title": "有可用更新",
      "body": "Aeldrune 有新版本可用。立即更新以获取最新修复和改进。",
      "bodyWithVersion": "Aeldrune {version} 版本已可用。立即更新以获取最新修复和改进。",
      "notNow": "暂不",
      "update": "更新"
    },
    "otaUpdate": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "Aeldrune 是一片你要靠双脚走遍的连续大陆。古道自南向北穿过起始山谷、沼泽和山峰，并越过它们继续攀升，通向其后的洼地以及地图顶端的雪境。自那条路向西展开一列更高等级的国度，向东另有一列，谷地东岸外还有一座岛屿。这里没有快速旅行，没有飞行路线，也没有马车：每一段路程都靠步行或骑乘完成，所以抵达本身就是冒险的一部分。\n\n这片大地也记录着时间。昼夜循环依照一只你所在世界人人共享的真实时钟运转，因此天空会为你们所有人同时从黎明经正午走向黄昏与夜色，月亮循着盈亏来去，地面上的光影也随之变化。小地图周围的表盘，就是你读取时辰的地方。",
      "hub": "大本营",
  ...
  "wallet": {
    ...
    "standaloneAppHelp": "主屏幕应用暂不支持连接钱包。若要使用 Phantom 或 Solflare，请在 Safari 或 Chrome 中打开 Aeldrune。",
    ...
    "manualReturnStandaloneHelp": "批准后请从主屏幕返回 Aeldrune。如果 iOS 打开了浏览器，请将其关闭并重新打开主屏幕应用。",
  ...
  "playerCard": {
    ...
    "shareText": "我正在 Aeldrune 中铸就传说：{level}级 {className}{tierBit}。加入我的世界：",
  ...
  "sim": {
    "rift": {
      ...
      "corpseRezCombat": "你的队伍仍在战斗中。战斗结束后即可复活。",
  ...
  "seo": {
    ...
    "description": "在 Aeldrune 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的世界，提升职业等级，击败敌人！",
    "genre": "MMORPG",
    "playMode": "多人游戏",
    "applicationCategory": "游戏",
    "operatingSystem": "网页浏览器",
    "officialLabel": "Aeldrune 官方网站",
    "officialBody": "Aeldrune 是 Aelvarin 世界的官方免费浏览器 MMO。你可以用持久角色在线游玩，也可以离线单人探索，阅读 wiki，并从本站访问已验证的社区链接。"
  },
  "a11y": {
    "goHome": "前往主页",
    "toggleMenu": "切换菜单",
  ...
  "desktop": {
    ...
    "notify": {
      ...
      "updateReadyBody": "重启 Aeldrune 以应用更新。",
    ...
    "crash": {
      ...
      "reload": "重新加载",
      "quit": "退出",
      "fatalBody": "Aeldrune 遇到意外错误，需要关闭。"
    }
  },
  "gpuNotice": {
  ...
  "serverUnavailable": {
    ...
    "eyebrow": "服务器维护",
    "heading": "服务器暂时不可用。",
    "body": "我们正在重启游戏服务，Aelvarin 应会很快恢复。此页面会自动继续检查。",
    "status": "即将恢复"
  },
  "hud": {
    "core": {
  ...
  "entities": {
    "abilities": {
      ...
      "mir4_skill_1304": {
        "name": "冲撞",
        "description": "对一名敌人造成 {damage} 点伤害。使目标的物理和魔法防御降低 12%，持续 4.5 秒。多个破防效果以乘法方式叠加，但防御不会低于原始值的 20%。上方显示的是基础冷却时间。技能冷却缩减在 PvE 中最多可降低 40%，在 PvP 中最多可降低 30%。"
      },
      "mir4_skill_1401": {
        "name": "大地重击",
      ...
      "mir4_skill_1501": {
        "name": "疾风斩",
        "description": "对一名敌人造成 {damage} 点伤害。7.75 码内最多 4 名其他敌人受到 65% 伤害。使每个命中的敌人减速 35%，持续 3.2 秒。"
      },
      "mir4_skill_1502": {
      ...
      "mir4_skill_2101": {
        "name": "火焰球",
        "description": "对一名敌人造成 {damage} 点伤害。6.5 码内最多 3 名其他敌人受到 65% 伤害。灼烧每个命中的敌人，每 1 秒造成 {burnPerTick} 点基础伤害（共 4 次，减伤前总计 {burnTotal} 点）。伤害取决于施加灼烧时你的法术强度。"
      },
      "mir4_skill_2111": {
        "name": "冰霜球",
        "description": "对一名敌人造成 {damage} 点伤害。6.5 码内最多 3 名其他敌人受到 65% 伤害。使每个命中的敌人减速 35%，持续 3.2 秒。"
      },
      "mir4_skill_2501": {
        "name": "唤出核心",
      ...
      "mir4_skill_3101": {
        "name": "印记连击",
        "description": "对一名敌人造成 {damage} 点伤害。6.5 码内最多 3 名其他敌人受到 65% 伤害。使每个命中的敌人的物理和魔法防御降低 10%，持续 4 秒。多个破防效果以乘法方式叠加，但防御不会低于原始值的 20%。上方显示的是基础冷却时间。技能冷却缩减在 PvE 中最多可降低 40%，在 PvP 中最多可降低 30%。"
      },
      "mir4_skill_3301": {
        "name": "图腾之印 II",
      ...
      "mir4_skill_3104": {
        "name": "刀刃之雨",
        "description": "以 4 次攻击造成 {damage} 点混合伤害。7.75 码内最多 4 名其他敌人受到 60% 伤害。达到 8 阶后，每个命中的敌人有 40% 几率被沉默 4 秒。"
      },
      "mir4_skill_3503": {
        "name": "玉莲",
      ...
      "mir4_skill_4107": {
        "name": "闪光箭",
        "description": "对一名敌人造成 {damage} 点伤害。6.75 码内最多 3 名其他敌人受到 60% 伤害，并使其造成的伤害降低 45%，持续 5 秒。"
      },
      "mir4_skill_4108": {
        "name": "Heavenly Bow",
      ...
      "mir4_skill_5104": {
        "name": "横扫 5104",
        "description": "对一名敌人造成 {damage} 点伤害。使目标的物理和魔法防御降低 14%，持续 4.5 秒。多个破防效果以乘法方式叠加，但防御不会低于原始值的 20%。上方显示的是基础冷却时间。技能冷却缩减在 PvE 中最多可降低 40%，在 PvP 中最多可降低 30%。"
      },
      "mir4_skill_5301": {
        "name": "锁链 5301",
      ...
      "mir4_skill_5401": {
        "name": "横扫风暴",
        "description": "造成 {damage} 点混合伤害，并使敌人造成的伤害降低 30%，持续 5 秒。"
      },
      "mir4_skill_5102": {
        "name": "Dragon Tail",
