...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wiki": {
      ...
      "confirmBody": "Aeldrune のWikiをブラウザで開きます。ゲームはそのまま続行されます。",
      "confirmOpen": "Wikiを開く",
      "confirmCancel": "キャンセル"
    },
    "unstuck": {
    ...
    "wocStore": {
      ...
      "wallet": {
        "title": "Solanaウォレット",
        "unlinked": "ウォレットアプリを接続し、一度署名して公開アドレスをAeldruneアカウントにリンクしてください。リカバリーフレーズや秘密鍵を受け取ることはありません。",
        "connectedUnlinked": "ウォレットアプリはこのブラウザに接続されていますが、公開アドレスはまだAeldruneアカウントにリンクされていません。",
    ...
    "mir4": {
      ...
      "inventoryRuntimeItems": "Aeldruneのネイティブアイテム",
      ...
      "mountTicketDawnDescription": "マウントを1体召喚します：コモン79%、アンコモン20%、レア1%。有効な召喚時にチケットを消費します。表示モデルはAeldruneのネイティブ外観で、記載されたMIR4ステータスが権威データです。",
      "mountTicketTwilightDescription": "マウントを1体召喚します：レア99%、エピック1%。エピックの結果は確認後に所持品になります。表示モデルはAeldruneのネイティブ外観です。",
      ...
      "spiritTicketDawnDescription": "精霊を1体召喚します：コモン79%、アンコモン20%、レア1%。有効な召喚時にチケットを消費します。アイコンはAeldruneのネイティブ表現で、記載されたMIR4効果のみが適用されます。",
      ...
      "spiritEffectShell": "Aeldruneのネイティブ表現とMIR4精霊効果",
    ...
    "nativeUpdate": {
      "title": "アップデートがあります",
      "body": "Aeldrune の新しいバージョンが利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。",
      "bodyWithVersion": "Aeldrune のバージョン {version} が利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。",
      "notNow": "後で",
      "update": "更新"
    },
    "otaUpdate": {
    ...
    "perf": {
      ...
      "diagnostics": {
        "panelAria": "Aeldrune パフォーマンス診断",
        "title": "Aeldrune パフォーマンス診断",
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "称号：Aelvarinのチャンピオン",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "Aeldruneは、徒歩で渡っていく、ひと続きの大地です。古い街道は南から北へ、始まりの谷、湿地、山嶺を貫き、その先の窪地と地図の北端の雪国へと登り続けます。その街道からは西へ高位の領邦がひと連なり、東にもうひと連なり開けており、ヴェイルの東岸沖には島が浮かんでいます。高速移動はなく、飛行路も馬車もありません。どの道のりも歩くか騎乗するかで進むので、たどり着くことそのものが冒険の一部です。\n\n大地は時も刻みます。昼夜の周期は、あなたのワールドにいる全員が共有する実際の時計で進むので、空は皆にとって同時に夜明けから正午、そして黄昏と闇へと移り変わり、月は満ち欠けを巡り、地上の光もそれにつれて変わります。ミニマップを囲む文字盤が、時刻を読み取る場所です。",
      "hub": "拠点",
  ...
  "wallet": {
    ...
    "standaloneAppHelp": "ホーム画面アプリでは、まだウォレットに接続できません。Phantom または Solflare を使用するには、Safari か Chrome で Aeldrune を開いてください。",
    ...
    "manualReturnStandaloneHelp": "承認後、ホーム画面から Aeldrune に戻ってください。iOS でブラウザが開いた場合は閉じ、ホーム画面のアプリをもう一度開いてください。",
    ...
    "browser": {
      ...
      "safety": "Aeldruneがリカバリーフレーズや秘密鍵を求めることはありません。",
      ...
      "completeBody": "Aeldruneデスクトップアプリに戻れます。",
  ...
  "playerCard": {
    ...
    "shareText": "Aeldruneで伝説を鍛えています: レベル{level} {className}{tierBit}。私のワールドに参加してください:",
    "nativeShareTitle": "Aeldruneの世界",
  ...
  "seo": {
    ...
    "description": "ブラウザで直接遊べるクラシック風マイクロMMO、Aeldrune で壮大な冒険に出ましょう。永続的な共有ワールドに参加し、クラスを育て、敵を倒してください。",
    "genre": "MMORPG",
    "playMode": "マルチプレイヤー",
    "applicationCategory": "ゲーム",
    "operatingSystem": "Webブラウザ",
    "officialLabel": "Aeldrune 公式サイト",
    "officialBody": "Aeldrune は Aelvarin ワールドの公式無料ブラウザMMOです。永続キャラクターでオンラインプレイし、オフラインでソロ探索し、wikiを読み、このサイトから確認済みのコミュニティリンクをたどれます。"
  },
  "a11y": {
    "goHome": "ホームへ移動",
  ...
  "desktop": {
    ...
    "notify": {
      ...
      "updateReadyBody": "アップデートを適用するには Aeldrune を再起動してください。",
    ...
    "crash": {
      ...
      "reload": "再読み込み",
      "quit": "終了",
      "fatalBody": "Aeldrune で予期しないエラーが発生したため、終了します。"
    }
  },
  "gpuNotice": {
  ...
  "serverUnavailable": {
    "title": "Aeldrune - ワールド利用不可",
    "logoAlt": "Aeldrune",
    "eyebrow": "ワールドメンテナンス",
    "heading": "ワールドは一時的に利用できません。",
    "body": "ゲームサービスを再起動しています。Aelvarinはまもなく戻る予定です。このページは自動的に確認を続けます。",
    "status": "まもなく復帰"
  },
  "hud": {
    "core": {
  ...
  "entities": {
    "abilities": {
      ...
      "mir4_skill_3503": {
        "name": "翡翠の蓮",
        "description": "自身と30ヤード以内のパーティメンバー最大4人の体力を毎秒{healPerPulse}、5秒間回復します（合計{healTotal}）。回復量は魔法攻撃力に応じて増加します。自身は2秒間、行動妨害効果を受けません。5段階では、自身の最大体力の10%、パーティメンバーは15%を即時回復します。8段階では即時回復量が25%と35%になり、沈黙中でも使用でき、沈黙を解除し、自身の弱体化を浄化してパーティメンバーの弱体化を50%の確率で浄化し、さらにボスダメージ軽減10%を30秒間付与します。10段階では即時回復量が40%と50%になり、パーティへの浄化が必ず成功して気絶も解除し、ボスダメージ軽減が20%、60秒間になります。"
      },
      "mir4_skill_3103": {
