...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wiki": {
      ...
      "confirmBody": "Aeldrune 위키를 브라우저에서 엽니다. 게임은 계속 실행됩니다.",
      "confirmOpen": "위키 열기",
      "confirmCancel": "취소"
    },
    "unstuck": {
    ...
    "wocStore": {
      ...
      "wallet": {
        "title": "Solana 지갑",
        "unlinked": "지갑 앱을 연결한 뒤 한 번 서명하여 공개 주소를 Aeldrune 계정에 연결하세요. 복구 문구나 개인 키는 절대로 전달되지 않습니다.",
        "connectedUnlinked": "지갑 앱이 이 브라우저에 연결되었지만 공개 주소는 아직 Aeldrune 계정에 연결되지 않았습니다.",
    ...
    "mir4": {
      ...
      "inventoryRuntimeItems": "Aeldrune 기본 아이템",
      ...
      "mountTicketDawnDescription": "탈것 하나를 소환합니다: 일반 79%, 고급 20%, 희귀 1%. 유효한 소환 시 소환권을 소모합니다. 표시 모델은 Aeldrune 기본 외형이며, 기재된 MIR4 능력치가 권한 데이터입니다.",
      "mountTicketTwilightDescription": "탈것 하나를 소환합니다: 희귀 99%, 영웅 1%. 영웅 결과는 확인 후 보유하게 됩니다. 표시 모델은 Aeldrune 기본 외형입니다.",
      ...
      "spiritTicketDawnDescription": "정령 하나를 소환합니다: 일반 79%, 고급 20%, 희귀 1%. 유효한 소환 시 소환권을 소모합니다. 아이콘은 Aeldrune 기본 표현이며, 기재된 MIR4 효과만 적용됩니다.",
      ...
      "spiritEffectShell": "Aeldrune 기본 표현과 MIR4 정령 효과",
    ...
    "nativeUpdate": {
      "title": "업데이트 사용 가능",
      "body": "Aeldrune의 새 버전을 사용할 수 있습니다. 지금 업데이트하여 최신 수정 사항과 개선 사항을 받으세요.",
      "bodyWithVersion": "Aeldrune 버전 {version}을(를) 사용할 수 있습니다. 지금 업데이트하여 최신 수정 사항과 개선 사항을 받으세요.",
      "notNow": "나중에",
      "update": "업데이트"
    },
    "otaUpdate": {
    ...
    "perf": {
      ...
      "diagnostics": {
        "panelAria": "Aeldrune 성능 진단",
        "title": "Aeldrune 성능 진단",
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "칭호: Aelvarin의 챔피언",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "세계",
      "intro": "Aeldrune는 당신이 두 발로 가로지르는 하나로 이어진 땅입니다. 옛 길은 남쪽에서 북쪽으로 시작의 골짜기와 늪지와 봉우리를 꿰뚫고, 그것들을 지나 그 너머의 분지와 지도 꼭대기의 눈의 땅까지 계속 올라갑니다. 그 길에서 서쪽으로 더 높은 왕국들이 한 줄, 동쪽으로 또 한 줄 열리고, 밸리의 동쪽 해안 앞바다에는 섬이 하나 놓여 있습니다. 빠른 이동도, 비행 경로도, 마차도 없습니다. 모든 여정은 걷거나 타고 가는 것이므로, 다다르는 일 자체가 모험의 일부입니다.\n\n이 땅은 시간도 셉니다. 낮과 밤의 순환은 당신의 세계에 있는 모두가 함께 쓰는 실제 시계로 돌아가므로, 하늘은 여러분 모두에게 동시에 새벽에서 한낮을 지나 황혼과 어둠으로 옮겨가고, 달은 차고 기울며 오가고, 땅 위의 빛도 그에 따라 바뀝니다. 미니맵을 두른 눈금판이 시각을 읽는 곳입니다.",
      "hub": "본거지",
  ...
  "wallet": {
    ...
    "standaloneAppHelp": "홈 화면 앱에서는 아직 지갑 연결을 사용할 수 없습니다. Phantom 또는 Solflare를 사용하려면 Safari나 Chrome에서 Aeldrune를 여세요.",
    ...
    "manualReturnStandaloneHelp": "승인 후 홈 화면에서 Aeldrune로 돌아오세요. iOS에서 브라우저가 열리면 닫고 홈 화면 앱을 다시 여세요.",
  ...
  "playerCard": {
    ...
    "shareText": "Aeldrune에서 제 전설을 벼리고 있습니다: {level}레벨 {className}{tierBit}. 제 월드에 합류하세요:",
    "nativeShareTitle": "Aeldrune의 세계",
  ...
  "seo": {
    ...
    "description": "브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, Aeldrune에서 장대한 모험을 시작하세요. 지속되는 공유 월드에 접속해 직업을 성장시키고 적을 물리치세요.",
    "genre": "MMORPG",
    "playMode": "멀티플레이어",
    "applicationCategory": "게임",
    "operatingSystem": "웹 브라우저",
    "officialLabel": "Aeldrune 공식 웹사이트",
    "officialBody": "Aeldrune은 Aelvarin 월드의 공식 무료 브라우저 MMO입니다. 지속 캐릭터로 온라인 플레이를 하거나, 오프라인에서 혼자 탐험하고, 위키를 읽고, 이 사이트에서 검증된 커뮤니티 링크를 확인하세요."
  },
  "a11y": {
    "goHome": "홈으로 이동",
    "toggleMenu": "메뉴 전환",
  ...
  "desktop": {
    ...
    "notify": {
      ...
      "updateReadyBody": "업데이트를 적용하려면 Aeldrune를 다시 시작하세요.",
    ...
    "crash": {
      ...
      "reload": "다시 불러오기",
      "quit": "종료",
      "fatalBody": "Aeldrune에 예기치 않은 오류가 발생하여 종료해야 합니다."
    }
  },
  "gpuNotice": {
  ...
  "serverUnavailable": {
    "title": "Aeldrune - 월드 이용 불가",
    "logoAlt": "Aeldrune",
    "eyebrow": "월드 점검",
    "heading": "월드를 일시적으로 이용할 수 없습니다.",
    "body": "게임 서비스를 재시작하고 있으며 Aelvarin은 곧 돌아올 예정입니다. 이 페이지는 자동으로 계속 확인합니다.",
    "status": "곧 돌아옵니다"
  },
  "hud": {
    "core": {
