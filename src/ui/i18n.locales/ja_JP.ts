...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  'classes.elementalist': 'エレメンタリスト',
  'classes.taoist': '道士',
  'classes.arbalist': '弩使い',
  'classes.lancer': 'ランサー',
  'classes.elementalistAria': 'エレメンタリストクラス',
  'classes.taoistAria': '道士クラス',
  'classes.arbalistAria': '弩使いクラス',
  'classes.lancerAria': 'ランサークラス',
  'classDetails.mir4.labels.damage': 'ダメージ',
  'classDetails.mir4.labels.combatRange': '戦闘距離',
  'classDetails.mir4.labels.startingSkills': '初期スキル',
  'classDetails.mir4.damage.physical': '物理',
  'classDetails.mir4.damage.magic': '魔法',
  'classDetails.mir4.range.melee': '近接',
  'classDetails.mir4.range.medium': '中距離',
  'classDetails.mir4.range.long': '遠距離',
  'classDetails.mir4.range.extended': '拡張近接',
  'classDetails.mir4.weapons.heavySword': '大剣',
  'classDetails.mir4.weapons.largeStaff': '大杖',
  'classDetails.mir4.weapons.shortStaff': '短杖',
  'classDetails.mir4.weapons.arbalest': '弩',
  'classDetails.mir4.weapons.spear': '槍',
  'classDetails.mir4.aria':
    '{className}の詳細：{damage}ダメージ、射程は{range}、武器は{weapon}、初期スキルは{skills}個。',
  'abilityUi.actionBar.autoBattleName': '自動戦闘',
  'abilityUi.actionBar.autoBattleTooltip':
    '現在位置の周囲で、自動索敵、移動、スキルローテーションを切り替えます。',
  'hudChrome.questTracker.mir4.firstTraces': '最初の痕跡',
  'hudChrome.questTracker.mir4.reachTarek': 'タレクのもとへ向かう',
  'hudChrome.questTracker.mir4.inspectClues': '手がかりを調べる',
  'hudChrome.questTracker.mir4.returnToTarek': 'タレクのもとへ戻る',
  'hudChrome.questTracker.mir4.pausedSuffix': '（手動操作により自動移動を一時停止）',
  'hudChrome.questTracker.mir4.startAutoJourney': '自動移動を開始',
  'hudChrome.questTracker.mir4.stopAutoJourney': '自動移動を停止',
  'hudChrome.mir4.ultimateGauge': 'アルティメットゲージ',
  'hudChrome.mir4.ultimateGaugeStatus': 'アルティメットゲージ：{value}/{max}',
  'hudChrome.mir4.ultimateReadyAnnouncement': 'アルティメット使用可能。',
  'hudChrome.mir4.achievements.title': '実績',
  'hudChrome.mir4.achievements.close': '実績を閉じる',
  'hudChrome.mir4.achievements.summary': '報酬受取済み：{claimed}/{total}',
  'hudChrome.mir4.achievements.balances':
    'カッパー {copper} · ダークスティール {darksteel} · EP {effectPoints} · スキル秘伝書 {skillTomes}',
  'hudChrome.mir4.achievements.levelTitle': 'レベル {level}',
  'hudChrome.mir4.achievements.levelDescription': 'レベル {level}に到達する。',
  'hudChrome.mir4.achievements.progressAria': 'レベル進行度：{current}/{target}',
  'hudChrome.mir4.achievements.progressText': '{current}／{target}',
  'hudChrome.mir4.achievements.rewardCopper': 'カッパー {amount}',
  'hudChrome.mir4.achievements.rewardDarksteel': 'ダークスティール {amount}',
  'hudChrome.mir4.achievements.rewardEffectPoints': 'エフェクトポイント {amount}',
  'hudChrome.mir4.achievements.rewardSkillTomes': 'スキル秘伝書 {amount}個',
  'hudChrome.mir4.achievements.rewards': '報酬：{rewards}',
  'hudChrome.mir4.achievements.claim': '受け取る',
  'hudChrome.mir4.achievements.claimed': '受取済み',
  'hudChrome.mir4.achievements.locked': 'レベル {level}に到達',
  'hudChrome.mir4.achievements.previousGrade': '先に前の段階の報酬を受け取ってください',
  'hudChrome.mir4.achievements.claimAria': 'レベル {level}の実績報酬を受け取る',
  'hudChrome.mir4.questLog.narrative':
    '渡し場周辺の3か所で手がかりを調べ、タレク・ツーブリッジのもとへ戻る。',
  'hudChrome.mir4.questLog.giverName': 'タレク・ツーブリッジ',
  'hudChrome.mir4.questLog.emptyHint':
    'M01の集落でタレク・ツーブリッジを探すか、自動移動を開始してください。',
  'hudChrome.mir4.questLog.completedHint':
    '「最初の痕跡」は完了しました。残りのキャンペーンクエストはまだ有効ではありません。',
  ...
  'hudChrome.mir4.unequipAria': '{item}を外す',
  'hudChrome.mir4.equipHint': 'クリックして装備。',
  'hudChrome.mir4.equipAria': '{item}を装備',
  'hudChrome.mir4.equipmentSlots.weapon': '武器',
  'hudChrome.mir4.equipmentSlots.necklace': '首飾り',
  'hudChrome.mir4.equipmentSlots.talisman': '護符',
  'hudChrome.mir4.equipmentSlots.chest': '胸当て',
  'hudChrome.mir4.equipmentSlots.helmet': '兜',
  'hudChrome.mir4.equipmentSlots.gloves': '手袋',
  'hudChrome.mir4.equipmentSlots.boots': 'ブーツ',
  'hudChrome.mir4.stats.combatPower': '戦闘力',
  'hudChrome.mir4.stats.maxHp': '最大体力',
  'hudChrome.mir4.stats.maxMana': '最大マナ',
  'hudChrome.mir4.stats.physicalAttack': '物理攻撃',
  'hudChrome.mir4.stats.magicAttack': '魔法攻撃',
  'hudChrome.mir4.stats.physicalDefense': '物理防御',
  'hudChrome.mir4.stats.magicDefense': '魔法防御',
  'hudChrome.mir4.stats.accuracy': '命中',
  'hudChrome.mir4.stats.dodge': '回避',
  'hudChrome.mir4.stats.critical': '会心',
  'hudChrome.mir4.stats.avoidCritical': '会心回避',
  'hudChrome.mir4.stats.criticalOutcome': '会心ダメージ',
  ...
  'hudChrome.mir4.materials.solarScroll': '太陽の巻物',
  'hudChrome.mir4.materials.lunarSeal': '月の印章',
  'hudChrome.mir4.materials.solarWard': '太陽の護符',
  'hudChrome.mir4.maps.portal': '{zone}のポータル',
  'hudChrome.mir4.maps.actWelcome': '{zone}（第{act}幕）。',
  'hudChrome.mir4.maps.m01': '渡し場の村',
  'hudChrome.mir4.maps.m02': '葦の小道',
  'hudChrome.mir4.maps.m03': '谷の森',
  'hudChrome.mir4.maps.m04': '丘陵の遺跡',
  'hudChrome.mir4.maps.m05': '裂け目の空き地',
  'hudChrome.mir4.maps.m06': '燭石の墓所',
  'hudChrome.mir4.maps.m07': '納骨堂回廊',
  'hudChrome.mir4.maps.m08': '霧石の要塞',
  'hudChrome.mir4.maps.m09': '灯籠沼',
  'hudChrome.mir4.maps.m11': '蛭のマングローブ',
  'hudChrome.mir4.maps.m12': '葦の港',
  'hudChrome.mir4.maps.m13': 'ガラスの砂丘',
  'hudChrome.mir4.maps.m14': 'アケトの死都',
  'hudChrome.mir4.maps.m15': 'シンダライト火口',
  'hudChrome.mir4.maps.m16': '砕けた太陽の炉',
  'hudChrome.mir4.maps.m17': '遠吠えのツンドラ',
  'hudChrome.mir4.maps.m19': '夜の帳',
  'hudChrome.mir4.maps.m20': '日蝕の砦',
  'hudChrome.mir4.progression.title': '装備工房',
  'hudChrome.mir4.progression.refinement': '精錬',
  'hudChrome.mir4.progression.enchantment': 'エンチャント',
  'hudChrome.mir4.progression.blessing': '祝福',
  'hudChrome.mir4.progression.crafting': '製作',
  'hudChrome.mir4.progression.ownedEquipment': '所持装備',
  'hudChrome.mir4.progression.noEquipment': 'この操作に使用できる装備がありません。',
  'hudChrome.mir4.progression.equipped': '装備中',
  'hudChrome.mir4.progression.enhancementLevel': '強化 +{level}/+{max}',
  'hudChrome.mir4.progression.successChance': '成功率：{chance}%',
  'hudChrome.mir4.progression.safeFailure': '失敗しても装備は残ります。',
  'hudChrome.mir4.progression.destructiveFailure': '+5を超える強化に失敗すると装備が破壊されます。',
  'hudChrome.mir4.progression.wardProtection': '破壊を防ぐため太陽の護符を1個消費します。',
  'hudChrome.mir4.progression.noWardProtection': '使用できる太陽の護符がありません。',
  'hudChrome.mir4.progression.enhanceCost': '費用：太陽の巻物 1個',
  'hudChrome.mir4.progression.enhance': '強化',
  'hudChrome.mir4.progression.maxEnhancement': '最大強化に到達しました',
  ...
  'hudChrome.mir4.progression.acceptPreview': 'プレビューを適用',
  'hudChrome.mir4.progression.keepCurrent': '現在の効果を維持',
  'hudChrome.mir4.progression.inactiveEffect': '移植済み効果（戦闘ではまだ無効）',
  'hudChrome.mir4.progression.materialRecipes': '素材レシピ',
  'hudChrome.mir4.progression.campaignProfession': 'キャンペーン製作依頼',
  'hudChrome.mir4.progression.campaignProfessionProgress': '進行度：{current}/{goal}',
  'hudChrome.mir4.progression.campaignProfessionMaterials': '対象素材：{held}/{needed}',
  'hudChrome.mir4.progression.campaignProfessionHint':
    'キャンペーンの製作地点で依頼を完了してください。サーバーは権威ある地域素材のみを消費します。',
  'hudChrome.mir4.progression.campaignCraft': '部品を製作',
  'hudChrome.mir4.progression.campaignRefine': '部品を精錬',
  'hudChrome.mir4.progression.campaignSalvage': '装備を分解',
  'hudChrome.mir4.progression.creates': '{material}を{count}個製作',
  'hudChrome.mir4.progression.copperCost': '銅貨 {amount}',
  ...
  'hudChrome.mir4.materialCount': '所持数：{count}',
  ...
  'hudChrome.mir4.noEquippedMount': 'マウント：未装備',
  'hudChrome.mir4.inventoryMountCombination': 'マウント合成',
  'hudChrome.mir4.combineMountsAria': '等級 {grade} のマウント4体を合成',
  'hudChrome.mir4.combineMountsHint':
    'この等級の所持マウントを4体消費します。20%の確率で次の等級のランダムなマウントを1体獲得します。失敗時は同じ等級のランダムなマウントを1体獲得します。エピック以上の報酬は確認待ちになります。',
  'hudChrome.mir4.inventorySpirits': '精霊',
  'hudChrome.mir4.inventoryPendingSpirits': '確認待ちの精霊',
  ...
  'hudChrome.mir4.spiritGrade': '等級 {grade}',
  'hudChrome.mir4.spiritOwned': '所持数：{count}',
  'hudChrome.mir4.spiritEquipped': '装備中',
  'hudChrome.mir4.spiritEquipHint': 'クリックしてこの精霊を装備します。属性とコレクションボーナスがMIR4ステータスに適用されます。',
  ...
  'hudChrome.mir4.combineSpiritsAria': '等級 {grade} の精霊4体を合成',
  'hudChrome.mir4.combineSpiritsHint':
    'この等級の所持精霊を4体消費します。20%の確率で次の等級のランダムな精霊を1体獲得します。失敗時は同じ等級のランダムな精霊を1体獲得します。エピック以上の報酬は確認待ちになります。',
  'hudChrome.mir4.spiritSkillChanceCooldown': '発動率{chance}% · クールダウン{cooldown}秒',
  'hudChrome.mir4.spiritSkillBonusDamage': '発動した攻撃の基礎ダメージを{amount}%増加させます。',
  'hudChrome.mir4.spiritSkillExecute':
    '対象の体力が{threshold}%以下の間、発動した攻撃の基礎ダメージを{amount}%増加させます。',
  'hudChrome.mir4.spiritSkillLifeSiphon': '最大体力の{amount}%を回復します。',
  'hudChrome.mir4.spiritSkillManaSurge': '最大マナの{amount}%を回復します。',
  'hudChrome.mir4.spiritSkillArmorRend': '発動した攻撃に防御貫通{amount}%を追加します。',
  'hudChrome.mir4.spiritSkillCriticalFocus': '発動した攻撃を必ず会心にします。',
  'hudChrome.noticeboard.contract': '有効な契約：{title}',
  'entities.abilities.mir4_skill_1102.name': '虚空撃',
  'entities.abilities.mir4_skill_1102.description': '敵1体に{damage}ダメージを与え、対象を0.9秒間スタンさせます。',
  'entities.abilities.mir4_skill_1104.name': '裂傷撃',
  ...
  'entities.abilities.mir4_skill_4102.name': '連撃 4102',
  'entities.abilities.mir4_skill_4102.description':
    '敵1体に{damage}ダメージを与えます。6.625ヤード以内の他の敵最大3体に65%のダメージを与え、対象を3.5秒間30%減速させます。',
  'entities.abilities.mir4_skill_4103.description':
    '敵1体に{damage}ダメージを与えます。7.5ヤード以内の他の敵最大4体に55%のダメージを与え、5秒間、対象が与えるダメージを60%減少させます。',
  ...
  'entities.abilities.mir4_ultimate_2.name': 'アルティメット',
  'entities.abilities.mir4_ultimate_2.description':
    '4回の攻撃で{damage}ダメージを与えます。アルティメットゲージが満タンである必要があります。',
  'entities.abilities.mir4_ultimate_3.name': 'アルティメット',
  'entities.abilities.mir4_ultimate_3.description':
    '3回の攻撃で{damage}ダメージを与えます。アルティメットゲージが満タンである必要があります。',
  'entities.abilities.mir4_ultimate_4.name': 'アルティメット',
  'entities.abilities.mir4_ultimate_4.description':
    '3回の攻撃で{damage}ダメージを与えます。アルティメットゲージが満タンである必要があります。',
  'entities.abilities.mir4_ultimate_5.name': 'アルティメット',
  'entities.abilities.mir4_ultimate_5.description':
    '2回の攻撃で{damage}ダメージを与えます。アルティメットゲージが満タンである必要があります。',
  'entities.abilities.mir4_passive_warrior_heavy_armor.name': '重装甲',
  'entities.abilities.mir4_passive_warrior_heavy_armor.description': '最大体力が8%増加します。',
  'entities.abilities.mir4_passive_warrior_weapon_mastery.name': '武器熟練',
  'entities.abilities.mir4_passive_warrior_weapon_mastery.description': '物理攻撃が6%増加します。',
  'entities.abilities.mir4_passive_warrior_iron_skin.description': '物理防御が8%、魔法防御が6%増加します。',
  'entities.abilities.mir4_passive_warrior_fighting_spirit.name': '闘志',
  'entities.abilities.mir4_passive_warrior_fighting_spirit.description': '最大体力と物理攻撃が4%増加します。',
  'entities.abilities.mir4_passive_warrior_indomitable_will.name': '不屈の意志',
  'entities.abilities.mir4_passive_warrior_indomitable_will.description':
    '最大体力、物理防御、魔法防御が5%増加します。',
  'entities.abilities.mir4_passive_elementalist_mana_well.description': '最大マナが10%増加します。',
  'entities.abilities.mir4_passive_elementalist_arcane_intellect.name': '秘術知性',
  'entities.abilities.mir4_passive_elementalist_arcane_intellect.description': '魔法攻撃が7%増加します。',
  ...
  'entities.abilities.mir4_passive_elementalist_elemental_protection.description':
    '物理防御と魔法防御が6%増加します。',
  'entities.abilities.mir4_passive_elementalist_channeling.name': '詠唱集中',
  'entities.abilities.mir4_passive_elementalist_channeling.description': '最大マナが5%、魔法攻撃が4%増加します。',
  'entities.abilities.mir4_passive_elementalist_arcane_ascension.name': '秘術昇華',
  'entities.abilities.mir4_passive_elementalist_arcane_ascension.description':
    '最大マナが5%、魔法攻撃が6%、物理防御と魔法防御が3%増加します。',
  'entities.abilities.mir4_passive_taoist_spiritual_vessel.name': '霊の器',
  'entities.abilities.mir4_passive_taoist_spiritual_vessel.description': '最大体力が4%、最大マナが7%増加します。',
  'entities.abilities.mir4_passive_taoist_twin_paths.name': '双道',
  'entities.abilities.mir4_passive_taoist_twin_paths.description': '物理攻撃と魔法攻撃が4%増加します。',
  'entities.abilities.mir4_passive_taoist_sacred_guard.name': '聖なる守り',
  'entities.abilities.mir4_passive_taoist_sacred_guard.description': '物理防御と魔法防御が6%増加します。',
  'entities.abilities.mir4_passive_taoist_serene_mind.name': '静穏の心',
  'entities.abilities.mir4_passive_taoist_serene_mind.description': '最大体力が4%、最大マナが5%増加します。',
  'entities.abilities.mir4_passive_taoist_celestial_harmony.name': '天の調和',
  'entities.abilities.mir4_passive_taoist_celestial_harmony.description':
    '最大体力、最大マナ、物理攻撃、魔法攻撃、物理防御、魔法防御が4%増加します。',
  'entities.abilities.mir4_passive_arbalist_eagle_eye.name': '鷹の目',
  'entities.abilities.mir4_passive_arbalist_eagle_eye.description': '物理攻撃が3%、命中が5%増加します。',
  'entities.abilities.mir4_passive_arbalist_ballistic_mastery.name': '弾道熟練',
  'entities.abilities.mir4_passive_arbalist_ballistic_mastery.description': '物理攻撃が7%増加します。',
  'entities.abilities.mir4_passive_arbalist_nature_guard.name': '自然の守り',
  'entities.abilities.mir4_passive_arbalist_nature_guard.description':
    '最大体力、物理防御、魔法防御が5%増加します。',
  'entities.abilities.mir4_passive_arbalist_hunter_instinct.name': '狩人の本能',
  'entities.abilities.mir4_passive_arbalist_hunter_instinct.description': '物理攻撃と回避が5%増加します。',
  'entities.abilities.mir4_passive_arbalist_perfect_shot.name': '完璧な一射',
  'entities.abilities.mir4_passive_arbalist_perfect_shot.description':
    '最大体力が3%、物理攻撃が6%、命中が5%増加します。',
  'entities.abilities.mir4_passive_lancer_war_conditioning.name': '戦場鍛錬',
  'entities.abilities.mir4_passive_lancer_war_conditioning.description':
    '最大体力が5%、物理攻撃と魔法攻撃が3%増加します。',
  'entities.abilities.mir4_passive_lancer_spear_mastery.name': '槍術熟練',
  'entities.abilities.mir4_passive_lancer_spear_mastery.description': '物理攻撃と魔法攻撃が5%増加します。',
  'entities.abilities.mir4_passive_lancer_vanguard_armor.name': '先鋒の鎧',
  'entities.abilities.mir4_passive_lancer_vanguard_armor.description': '物理防御と魔法防御が6%増加します。',
  'entities.abilities.mir4_passive_lancer_battle_rhythm.name': '戦闘律動',
  'entities.abilities.mir4_passive_lancer_battle_rhythm.description':
    '最大マナ、物理攻撃、魔法攻撃が4%増加します。',
  'entities.abilities.mir4_passive_lancer_dragon_vanguard.name': '竜の先鋒',
  'entities.abilities.mir4_passive_lancer_dragon_vanguard.description':
    '最大体力が4%、物理攻撃、魔法攻撃、物理防御、魔法防御が5%増加します。',
  'hudChrome.mir4.campaign.questTitle': 'キャンペーン {id}',
  'hudChrome.mir4.campaign.narrative': '{id}の現在のキャンペーン目標を達成する。',
  'hudChrome.mir4.campaign.contact': 'キャンペーン担当者',
  'hudChrome.mir4.campaign.objective.returnToContact': 'キャンペーン担当者のもとへ戻る',
  'hudChrome.mir4.campaign.objective.talk': 'キャンペーン担当者と話す',
  'hudChrome.mir4.campaign.objective.deliver': '要求されたアイテムを届ける',
  'hudChrome.mir4.campaign.objective.travel': 'マークされた目的地へ向かう',
  'hudChrome.mir4.campaign.objective.inspect': 'マークされた証拠を調べる',
  'hudChrome.mir4.campaign.objective.gather': '要求された資源を集める',
  'hudChrome.mir4.campaign.objective.defend': 'マークされた目標を防衛する',
  'hudChrome.mir4.campaign.objective.combat': 'マークされた敵を倒す',
  'hudChrome.mir4.campaign.objective.escort': 'マークされた味方を護衛する',
  'hudChrome.mir4.campaign.objective.escortSupplies': '補給隊を護衛する',
  'hudChrome.mir4.campaign.objective.dungeon': 'キャンペーンダンジョンを攻略する',
  'hudChrome.mir4.campaign.objective.craft': '要求された物資を製作する',
  'hudChrome.mir4.campaign.objective.tutorial': 'システムチュートリアルを完了する',
  'hudChrome.mir4.campaign.objective.interact': 'マークされた対象を操作する',
  'hudChrome.mir4.campaign.objective.complete': '現在の目標を達成する',
  ...
  'hudChrome.spellbook.maxRank': '最大ランク',
  ...
  'entities.dungeons.campaign_trial_room.name': 'キャンペーンの試練',
  'entities.dungeons.campaign_trial_room.enterText': 'キャンペーンの試練に入ります。',
  'entities.dungeons.campaign_trial_room.leaveText': 'キャンペーンの試練を出ます。',
  ...
  'hudChrome.mir4.collectibles.mounts.moss-boar': '苔猪',
  'hudChrome.mir4.collectibles.mounts.brook-stag': '小川雄鹿',
  'hudChrome.mir4.collectibles.mounts.gray-wolf': '灰色狼',
  'hudChrome.mir4.collectibles.mounts.dun-packhorse': '栗毛荷馬',
  'hudChrome.mir4.collectibles.mounts.birch-doe': '白樺雌鹿',
  'hudChrome.mir4.collectibles.mounts.red-maned-pony': '赤鬣ポニー',
  'hudChrome.mir4.collectibles.mounts.lowland-elk': '低地ヘラジカ',
  'hudChrome.mir4.collectibles.mounts.field-lynx': '野原オオヤマネコ',
  'hudChrome.mir4.collectibles.mounts.tawny-mastiff': '黄褐マスティフ',
  'hudChrome.mir4.collectibles.mounts.dune-jackal': '砂丘ジャッカル',
  'hudChrome.mir4.collectibles.mounts.reed-puma': '葦ピューマ',
  'hudChrome.mir4.collectibles.mounts.clay-ox': '粘土牛',
  'hudChrome.mir4.collectibles.mounts.valley-buffalo': '谷水牛',
  'hudChrome.mir4.collectibles.mounts.shaggy-yak': '毛長ヤク',
  'hudChrome.mir4.collectibles.mounts.creek-lizard': '渓流トカゲ',
  'hudChrome.mir4.collectibles.mounts.shellback-tortoise': '石甲羅リクガメ',
  'hudChrome.mir4.collectibles.mounts.plains-ostrich': '平原ダチョウ',
  'hudChrome.mir4.collectibles.mounts.dusk-emu': '黄昏レア',
  'hudChrome.mir4.collectibles.mounts.copper-ant-carrier': '銅蟻運搬獣',
  'hudChrome.mir4.collectibles.mounts.mist-moose': '霧ヘラジカ',
  'hudChrome.mir4.collectibles.mounts.leaf-panther': '葉豹',
  'hudChrome.mir4.collectibles.mounts.turf-rhino': '芝サイ',
  'hudChrome.mir4.collectibles.mounts.valley-monitor': '谷オオトカゲ',
  'hudChrome.mir4.collectibles.mounts.granite-ibex': '花崗岩アイベックス',
  'hudChrome.mir4.collectibles.mounts.silver-dapple-mare': '銀斑雌馬',
  'hudChrome.mir4.collectibles.mounts.marsh-stag': '沼地雄鹿',
  'hudChrome.mir4.collectibles.mounts.snow-mane-lion': '雪鬣獅子',
  'hudChrome.mir4.collectibles.mounts.ember-fox': '残り火狐',
  'hudChrome.mir4.collectibles.mounts.striped-hyena': '縞ハイエナ',
  'hudChrome.mir4.collectibles.mounts.iron-tusk-boar': '鉄牙猪',
  'hudChrome.mir4.collectibles.mounts.cedar-bear': '杉熊',
  'hudChrome.mir4.collectibles.mounts.swamp-hippo': '湿地カバ',
  'hudChrome.mir4.collectibles.mounts.thorn-iguana': '棘イグアナ',
  'hudChrome.mir4.collectibles.mounts.dryland-crocodile': '乾地ワニ',
  'hudChrome.mir4.collectibles.mounts.horned-cassowary': '角持ちヒクイドリ',
  'hudChrome.mir4.collectibles.mounts.bronze-raptor': '青銅ラプトル',
  'hudChrome.mir4.collectibles.mounts.amber-scarab': '琥珀スカラベ',
  'hudChrome.mir4.collectibles.mounts.dune-scorpion': '砂丘サソリ',
  'hudChrome.mir4.collectibles.mounts.root-golem': '根ゴーレム',
  'hudChrome.mir4.collectibles.mounts.amber-bear': '琥珀熊',
  'hudChrome.mir4.collectibles.mounts.sunset-tiger': '夕焼け虎',
  'hudChrome.mir4.collectibles.mounts.root-drake': '根ドレイク',
  'hudChrome.mir4.collectibles.mounts.hill-griffin': '丘グリフォン',
  'hudChrome.mir4.collectibles.mounts.obsidian-zebra': '黒曜石シマウマ',
  'hudChrome.mir4.collectibles.mounts.stormhorn-ram': '嵐角牡羊',
  'hudChrome.mir4.collectibles.mounts.dusk-elk': '黄昏ヘラジカ',
  'hudChrome.mir4.collectibles.mounts.frost-warg': '霜ワーグ',
  'hudChrome.mir4.collectibles.mounts.basalt-rhino': '玄武岩サイ',
  'hudChrome.mir4.collectibles.mounts.tundra-mammoth': 'ツンドラマンモス',
  'hudChrome.mir4.collectibles.mounts.crystal-ankylosaur': '水晶アンキロサウルス',
  'hudChrome.mir4.collectibles.mounts.ember-salamander': '残り火サラマンダー',
  'hudChrome.mir4.collectibles.mounts.thunder-komodo': '雷コモド',
  'hudChrome.mir4.collectibles.mounts.moon-crocodile': '月ワニ',
  'hudChrome.mir4.collectibles.mounts.razorbeak-strider': '刃嘴ストライダー',
  'hudChrome.mir4.collectibles.mounts.plume-raptor': '羽冠ラプトル',
  'hudChrome.mir4.collectibles.mounts.glass-mantis': '硝子カマキリ',
  'hudChrome.mir4.collectibles.mounts.thunder-beetle': '雷甲虫',
  'hudChrome.mir4.collectibles.mounts.iron-sentinel': '鉄番兵',
  'hudChrome.mir4.collectibles.mounts.mossstone-colossus': '苔石巨像',
  'hudChrome.mir4.collectibles.mounts.eclipse-lion': '蝕獅子',
  'hudChrome.mir4.collectibles.mounts.crimson-wyvern': '紅蓮ワイバーン',
  'hudChrome.mir4.collectibles.mounts.astral-stag': '星界雄鹿',
  'hudChrome.mir4.collectibles.mounts.jade-basilisk': '翡翠バジリスク',
  'hudChrome.mir4.collectibles.mounts.solar-wolf': '太陽狼',
  'hudChrome.mir4.collectibles.mounts.forest-chimera': '森キマイラ',
  'hudChrome.mir4.collectibles.mounts.tempest-courser': '嵐駿馬',
  'hudChrome.mir4.collectibles.mounts.thorn-elephant': '棘象',
  'hudChrome.mir4.collectibles.mounts.void-spider': '虚空蜘蛛',
  'hudChrome.mir4.collectibles.mounts.rune-golem': 'ルーンゴーレム',
  'hudChrome.mir4.collectibles.mounts.dawn-phoenix': '暁不死鳥',
  'hudChrome.mir4.collectibles.mounts.imperial-griffin': '帝国グリフォン',
  'hudChrome.mir4.collectibles.mounts.stone-leviathan': '石リヴァイアサン',
  'hudChrome.mir4.collectibles.mounts.void-unicorn': '虚空ユニコーン',
  'hudChrome.mir4.collectibles.mounts.golden-manticore': '黄金マンティコア',
  'hudChrome.mir4.collectibles.mounts.imperial-tiger': '帝国虎',
  'hudChrome.mir4.collectibles.mounts.dawn-mammoth': '暁マンモス',
  'hudChrome.mir4.collectibles.mounts.magma-drake': 'マグマドレイク',
  'hudChrome.mir4.collectibles.mounts.crown-scorpion': '王冠サソリ',
  'hudChrome.mir4.collectibles.mounts.sunforged-colossus': '陽鍛巨像',
  'hudChrome.mir4.collectibles.mounts.ground-dragon': '大地竜',
  'hudChrome.mir4.collectibles.mounts.eternal-phoenix': '永遠不死鳥',
  'hudChrome.mir4.collectibles.mounts.celestial-kirin': '天界麒麟',
  'hudChrome.mir4.collectibles.mounts.firmament-behemoth': '天穹の獅子',
  'hudChrome.mir4.collectibles.mounts.time-hydra': '時ヒュドラ',
  'hudChrome.mir4.collectibles.spirits.spirit-common-01': '草原火花',
  'hudChrome.mir4.collectibles.spirits.spirit-common-02': '小川のそよ風',
  'hudChrome.mir4.collectibles.spirits.spirit-common-03': '見張りの葉',
  'hudChrome.mir4.collectibles.spirits.spirit-common-04': '石木霊',
  'hudChrome.mir4.collectibles.spirits.spirit-uncommon-01': '暁の輝き',
  'hudChrome.mir4.collectibles.spirits.spirit-uncommon-02': '霧ニンフ',
  'hudChrome.mir4.collectibles.spirits.spirit-uncommon-03': '苔守護者',
  'hudChrome.mir4.collectibles.spirits.spirit-uncommon-04': '谷サラマンダー',
  'hudChrome.mir4.collectibles.spirits.spirit-rare-01': '琥珀狐',
  'hudChrome.mir4.collectibles.spirits.spirit-rare-02': '夕焼け梟',
  'hudChrome.mir4.collectibles.spirits.spirit-rare-03': '根ドレイク',
  'hudChrome.mir4.collectibles.spirits.spirit-rare-04': '丘の神託者',
  'hudChrome.mir4.collectibles.spirits.spirit-epic-01': '蝕化身',
  'hudChrome.mir4.collectibles.spirits.spirit-epic-02': '紅蓮イフリート',
  'hudChrome.mir4.collectibles.spirits.spirit-epic-03': '星界雄鹿',
  'hudChrome.mir4.collectibles.spirits.spirit-epic-04': '翡翠番兵',
  'hudChrome.mir4.collectibles.spirits.spirit-epic-05': '太陽狼',
  'hudChrome.mir4.collectibles.spirits.spirit-epic-06': '霊妙キマイラ',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-01': '大地タイタン',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-02': '暁不死鳥',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-03': '帝国アルコン',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-04': '水晶リヴァイアサン',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-05': '虚空ユニコーン',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-06': '黄金マンティコア',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-01': '原初魂',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-02': '永遠不死鳥',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-03': '天界麒麟',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-04': '天穹のベヒーモス',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-05': '深淵セラフ',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-06': '時ヒュドラ',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-1-01': '彷徨う火花',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-1-02': '黄昏本能',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-1-03': '生命露',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-1-04': 'マナ息吹',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-2-01': '昇り閃光',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-2-02': '霧牙',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-2-03': '癒やし樹液',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-2-04': '秘術脈動',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-3-01': '琥珀破裂',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-3-02': '夕焼け審判',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-3-03': '生命絆',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-3-04': '根泉',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-01': '蝕光線',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-02': '紅蓮怒り',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-03': '星界恩寵',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-04': '翡翠宝珠',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-05': '太陽斬',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-06': '霊妙集中',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-01': '地殻衝撃',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-02': '再生炎',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-03': '帝国判決',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-04': '水晶潮',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-05': '虚空裂け目',
  ...
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-6-02': '永遠帰還',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-6-03': '天界勅命',
