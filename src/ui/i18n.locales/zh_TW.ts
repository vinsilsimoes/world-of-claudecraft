...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.wallet.unlinked':
    '連接錢包應用程式，然後簽署一次，將其公開地址綁定到你的 Aeldrune 帳號。我們絕不會取得你的復原短語或私鑰。',
  'hudChrome.wocStore.wallet.connectedUnlinked':
    '錢包應用程式已連接到此瀏覽器，但其公開地址尚未綁定到你的 Aeldrune 帳號。',
  ...
  'seo.officialLabel': 'Aeldrune 官方網站',
  'seo.officialBody':
    'Aeldrune 是 Aelvarin 世界的官方免費瀏覽器 MMO。你可以用持久角色線上遊玩，也可以離線單人探索、閱讀 wiki，並從本站前往已驗證的社群連結。',
  ...
  'wallet.standaloneAppHelp':
    '主畫面應用程式目前尚不支援連接錢包。若要使用 Phantom 或 Solflare，請在 Safari 或 Chrome 中開啟 Aeldrune。',
  ...
  'wallet.manualReturnStandaloneHelp':
    '核准後請從主畫面返回 Aeldrune。如果 iOS 開啟了瀏覽器，請將其關閉並重新開啟主畫面 App。',
  ...
  'wallet.browser.safety': 'Aeldrune 絕不會要求復原短語或私鑰。',
  ...
  'wallet.browser.completeBody': '現在可以返回 Aeldrune 桌面應用程式。',
  ...
  'playerCard.defaultRealm': 'Aeldrune 世界',
  ...
  'playerCard.shareText':
    '我正在 Aeldrune 中鑄就傳說：{level}級 {className}{tierBit}。加入我的世界：',
  'playerCard.nativeShareTitle': 'Aeldrune 世界',
  ...
  'controls.chat': '開啟對話框',
  'seo.title': 'Aeldrune：經典風格網頁 MMO',
  'seo.description':
    '在 Aeldrune 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的世界，提升職業等級並擊敗敵人！',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人遊戲',
  ...
  'a11y.githubProject': '開啟 Aeldrune 的 GitHub 專案',
  'a11y.discordCommunity': '加入 Aeldrune 的 Discord 社群',
  'a11y.donateProject': '捐贈支持 Aeldrune',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '從新的主畫面圖示開啟 Aeldrune。',
  ...
  'guide.worldPage.intro': 'Aeldrune 是一片你要靠雙腳走遍的連續大陸。古道自南向北穿過起始山谷、沼澤和山峰，並越過它們繼續攀升，通向其後的窪地以及地圖頂端的雪境。自那條路向西展開一列更高等級的國度，向東另有一列，谷地東岸外還有一座島嶼。這裡沒有快速旅行，沒有飛行路線，也沒有馬車：每一段路程都靠步行或騎乘完成，所以抵達本身就是冒險的一部分。\n\n這片大地也記錄著時間。晝夜循環依照一只你所在世界人人共享的真實時鐘運轉，因此天空會為你們所有人同時從黎明經正午走向黃昏與夜色，月亮循著盈虧來去，地面上的光影也隨之變化。小地圖周圍的錶盤，就是你讀取時辰的地方。',
  ...
  'hudChrome.discord.swag.titleChampion': '稱號：Aelvarin 勇士',
  ...
  'hudChrome.nativeUpdate.body':
    'Aeldrune 有新版本可用。立即更新以取得最新修正與改進。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Aeldrune {version} 版本已可用。立即更新以取得最新修正與改進。',
  ...
  'desktop.notify.updateReadyBody': '重新啟動 Aeldrune 以套用更新。',
  ...
  'desktop.crash.fatalBody': 'Aeldrune 發生未預期的錯誤，必須關閉。',
  ...
  'editor.docTitle': '地圖編輯器 - Aeldrune',
  ...
  'hudChrome.wiki.confirmBody': '將在瀏覽器中開啟 Aeldrune 維基，遊戲會繼續執行。',
  ...
  'hudChrome.perf.diagnostics.panelAria': 'Aeldrune 效能診斷',
  'hudChrome.perf.diagnostics.title': 'Aeldrune 效能醫生',
  ...
  'hudChrome.perf.diagnostics.report.title': 'Aeldrune 效能診斷',
  ...
  'classes.elementalist': '元素師',
  'classes.taoist': '道士',
  'classes.arbalist': '弩手',
  'classes.lancer': '槍騎士',
  'classes.elementalistAria': '元素師職業',
  'classes.taoistAria': '道士職業',
  'classes.arbalistAria': '弩手職業',
  'classes.lancerAria': '槍騎士職業',
  'classDetails.mir4.labels.damage': '傷害',
  'classDetails.mir4.labels.combatRange': '戰鬥距離',
  'classDetails.mir4.labels.startingSkills': '初始技能',
  'classDetails.mir4.damage.physical': '物理',
  'classDetails.mir4.damage.magic': '魔法',
  'classDetails.mir4.range.melee': '近戰',
  'classDetails.mir4.range.medium': '中距離',
  'classDetails.mir4.range.long': '遠距離',
  'classDetails.mir4.range.extended': '延伸近戰',
  'classDetails.mir4.weapons.heavySword': '重劍',
  'classDetails.mir4.weapons.largeStaff': '長法杖',
  'classDetails.mir4.weapons.shortStaff': '短法杖',
  'classDetails.mir4.weapons.arbalest': '弩',
  'classDetails.mir4.weapons.spear': '長槍',
  'classDetails.mir4.aria':
    '{className}職業詳情：{damage}傷害，{range}距離，武器為{weapon}，擁有{skills}個初始技能。',
  'abilityUi.actionBar.autoBattleName': '自動戰鬥',
  'abilityUi.actionBar.autoBattleTooltip':
    '切換目前位置周圍的自動索敵、移動和技能循環。',
  'hudChrome.questTracker.mir4.firstTraces': '最初的痕跡',
  'hudChrome.questTracker.mir4.reachTarek': '前往塔雷克處',
  'hudChrome.questTracker.mir4.inspectClues': '檢查線索',
  'hudChrome.questTracker.mir4.returnToTarek': '返回塔雷克處',
  'hudChrome.questTracker.mir4.pausedSuffix': '（自動旅程因手動操作而暫停）',
  'hudChrome.questTracker.mir4.startAutoJourney': '開始自動旅程',
  'hudChrome.questTracker.mir4.stopAutoJourney': '停止自動旅程',
  'hudChrome.mir4.ultimateGauge': '終極技能能量',
  'hudChrome.mir4.ultimateGaugeStatus': '終極技能能量：{value}/{max}',
  'hudChrome.mir4.ultimateReadyAnnouncement': '終極技能已就緒。',
  'hudChrome.mir4.achievements.title': '成就',
  'hudChrome.mir4.achievements.close': '關閉成就',
  'hudChrome.mir4.achievements.summary': '已領取獎勵：{claimed}/{total}',
  'hudChrome.mir4.achievements.balances':
    '銅幣 {copper} · 黑鐵 {darksteel} · 效果點數 {effectPoints} · 技能秘笈 {skillTomes}',
  'hudChrome.mir4.achievements.levelTitle': '等級 {level}',
  'hudChrome.mir4.achievements.levelDescription': '達到等級 {level}。',
  'hudChrome.mir4.achievements.progressAria': '等級進度：{current}/{target}',
  'hudChrome.mir4.achievements.progressText': '{current}／{target}',
  'hudChrome.mir4.achievements.rewardCopper': '銅幣 {amount}',
  'hudChrome.mir4.achievements.rewardDarksteel': '黑鐵 {amount}',
  'hudChrome.mir4.achievements.rewardEffectPoints': '效果點數 {amount}',
  'hudChrome.mir4.achievements.rewardSkillTomes': '技能秘笈 {amount} 本',
  'hudChrome.mir4.achievements.rewards': '獎勵：{rewards}',
  'hudChrome.mir4.achievements.claim': '領取',
  'hudChrome.mir4.achievements.claimed': '已領取',
  'hudChrome.mir4.achievements.locked': '達到等級 {level}',
  'hudChrome.mir4.achievements.previousGrade': '請先領取上一階段獎勵',
  'hudChrome.mir4.achievements.claimAria': '領取等級 {level} 成就獎勵',
  'hudChrome.mir4.questLog.narrative':
    '調查渡口周圍的三個線索地點，然後返回塔雷克·雙橋處。',
  'hudChrome.mir4.questLog.giverName': '塔雷克·雙橋',
  'hudChrome.mir4.questLog.emptyHint': '在 M01 聚落找到塔雷克·雙橋，或開始自動旅程。',
  'hudChrome.mir4.questLog.completedHint': '「最初的痕跡」已完成。其餘戰役任務尚未啟用。',
  'hudChrome.mir4.characterTitle': '角色',
  'hudChrome.mir4.awaitingState': '正在等待權威角色資料……',
  'hudChrome.mir4.combatPowerLine': '戰力 {value}',
  'hudChrome.mir4.equipmentVisualShell': '採用 Aeldrune 外觀與 MIR4 戰鬥屬性',
  'hudChrome.mir4.equipmentTierGrade': '階層 {tier}，品級 {grade}',
  'hudChrome.mir4.equipmentRequiredLevel': '需要等級 {level}',
  'hudChrome.mir4.unequipHint': '點擊 X 或按右鍵以卸下。',
  'hudChrome.mir4.unequipAria': '卸下 {item}',
  'hudChrome.mir4.equipHint': '點擊裝備。',
  'hudChrome.mir4.equipAria': '裝備 {item}',
  'hudChrome.mir4.equipmentSlots.weapon': '武器',
  'hudChrome.mir4.equipmentSlots.necklace': '項鍊',
  'hudChrome.mir4.equipmentSlots.talisman': '護符',
  'hudChrome.mir4.equipmentSlots.chest': '胸甲',
  'hudChrome.mir4.equipmentSlots.helmet': '頭盔',
  'hudChrome.mir4.equipmentSlots.gloves': '手套',
  'hudChrome.mir4.equipmentSlots.boots': '靴子',
  'hudChrome.mir4.stats.combatPower': '戰力',
  'hudChrome.mir4.stats.maxHp': '最大生命值',
  'hudChrome.mir4.stats.maxMana': '最大法力值',
  'hudChrome.mir4.stats.physicalAttack': '物理攻擊',
  'hudChrome.mir4.stats.magicAttack': '魔法攻擊',
  'hudChrome.mir4.stats.physicalDefense': '物理防禦',
  'hudChrome.mir4.stats.magicDefense': '魔法防禦',
  'hudChrome.mir4.stats.accuracy': '命中',
  'hudChrome.mir4.stats.dodge': '閃避',
  'hudChrome.mir4.stats.critical': '暴擊',
  'hudChrome.mir4.stats.avoidCritical': '暴擊閃避',
  'hudChrome.mir4.stats.criticalOutcome': '暴擊傷害',
  'hudChrome.mir4.stats.bossDamage': '首領傷害',
  'hudChrome.mir4.stats.skillDamage': '技能傷害',
  'hudChrome.mir4.stats.penetration': '防禦穿透',
  'hudChrome.mir4.stats.penetrationProtection': '防禦穿透防護',
  'hudChrome.mir4.stats.unknown': '戰鬥屬性',
  'hudChrome.mir4.materials.sunStone': '太陽石',
  'hudChrome.mir4.materials.moonStone': '月亮石',
  'hudChrome.mir4.materials.solarScroll': '太陽卷軸',
  'hudChrome.mir4.materials.lunarSeal': '月之印',
  'hudChrome.mir4.materials.solarWard': '太陽護符',
  'hudChrome.mir4.maps.portal': '{zone}傳送門',
  'hudChrome.mir4.maps.actWelcome': '{zone}（第{act}幕）。',
  'hudChrome.mir4.maps.m01': '渡口村',
  'hudChrome.mir4.maps.m02': '蘆葦小徑',
  'hudChrome.mir4.maps.m03': '山谷林地',
  'hudChrome.mir4.maps.m04': '山坡遺跡',
  'hudChrome.mir4.maps.m05': '裂隙林間地',
  'hudChrome.mir4.maps.m06': '燭石墓穴',
  'hudChrome.mir4.maps.m07': '藏骨迴廊',
  'hudChrome.mir4.maps.m08': '霧石要塞',
  'hudChrome.mir4.maps.m09': '燈籠沼澤',
  'hudChrome.mir4.maps.m11': '水蛭紅樹林',
  'hudChrome.mir4.maps.m12': '蘆葦港',
  'hudChrome.mir4.maps.m13': '玻璃沙丘',
  'hudChrome.mir4.maps.m14': '阿赫特死靈城',
  'hudChrome.mir4.maps.m15': '燼岩火山口',
  'hudChrome.mir4.maps.m16': '破碎太陽熔爐',
  'hudChrome.mir4.maps.m17': '呼嘯苔原',
  'hudChrome.mir4.maps.m19': '夜幕',
  'hudChrome.mir4.maps.m20': '日蝕堡壘',
  'hudChrome.mir4.progression.title': '裝備工坊',
  'hudChrome.mir4.progression.refinement': '精煉',
  'hudChrome.mir4.progression.enchantment': '附魔',
  'hudChrome.mir4.progression.blessing': '祝福',
  'hudChrome.mir4.progression.crafting': '製作',
  'hudChrome.mir4.progression.ownedEquipment': '已擁有裝備',
  'hudChrome.mir4.progression.noEquipment': '此操作沒有可用裝備。',
  'hudChrome.mir4.progression.equipped': '已裝備',
  'hudChrome.mir4.progression.enhancementLevel': '強化 +{level}/+{max}',
  'hudChrome.mir4.progression.successChance': '成功率：{chance}%',
  'hudChrome.mir4.progression.safeFailure': '失敗時保留裝備。',
  'hudChrome.mir4.progression.destructiveFailure': '+5 以上強化失敗會摧毀裝備。',
  'hudChrome.mir4.progression.wardProtection': '將消耗一個太陽護符以防止裝備被摧毀。',
  'hudChrome.mir4.progression.noWardProtection': '沒有可用的太陽護符。',
  'hudChrome.mir4.progression.enhanceCost': '費用：1 個太陽卷軸',
  'hudChrome.mir4.progression.enhance': '強化',
  'hudChrome.mir4.progression.maxEnhancement': '已達到最高強化等級',
  'hudChrome.mir4.progression.currentEffects': '目前效果',
  'hudChrome.mir4.progression.noCurrentEffects': '沒有已套用的效果。',
  'hudChrome.mir4.progression.rollCostEnchantment': '費用：1 個月之印',
  'hudChrome.mir4.progression.layerUnsupported': '此物品無法獲得{layer}效果。',
  'hudChrome.mir4.progression.roll': '產生預覽',
  'hudChrome.mir4.progression.pendingOtherLayer': '請先處理待定的{layer}預覽。',
  'hudChrome.mir4.progression.preview': '待定預覽',
  'hudChrome.mir4.progression.acceptPreview': '套用預覽',
  'hudChrome.mir4.progression.keepCurrent': '保留目前效果',
  'hudChrome.mir4.progression.inactiveEffect': '已移植效果（尚未在戰鬥中生效）',
  'hudChrome.mir4.progression.materialRecipes': '材料配方',
  'hudChrome.mir4.progression.campaignProfession': '戰役專業訂單',
  'hudChrome.mir4.progression.campaignProfessionProgress': '進度：{current}/{goal}',
  'hudChrome.mir4.progression.campaignProfessionMaterials': '合格材料：{held}/{needed}',
  'hudChrome.mir4.progression.campaignProfessionHint':
    '在戰役製作錨點完成此訂單。伺服器只會消耗權威的地區材料。',
  'hudChrome.mir4.progression.campaignCraft': '製作組件',
  'hudChrome.mir4.progression.campaignRefine': '精煉組件',
  'hudChrome.mir4.progression.campaignSalvage': '分解裝備',
  'hudChrome.mir4.progression.creates': '製作 {count} 個{material}',
  'hudChrome.mir4.progression.copperCost': '{amount} 銅幣',
  'hudChrome.mir4.progression.create': '製作',
  'hudChrome.mir4.progression.requestSent': '伺服器正在驗證裝備操作。',
  'hudChrome.mir4.inventoryEquipment': '裝備',
  'hudChrome.mir4.inventoryRuntimeItems': 'Aeldrune 原生物品',
  'hudChrome.mir4.inventoryCollectionTickets': '收藏券',
  'hudChrome.mir4.inventoryMaterials': '精煉材料',
  'hudChrome.mir4.noUnequippedEquipment': '沒有未裝備的裝備。',
  'hudChrome.mir4.materialCount': '擁有：{count}',
  'hudChrome.mir4.mountTicketDawn': '晨曦坐騎召喚券',
  'hudChrome.mir4.mountTicketTwilight': '暮光坐騎召喚券',
  'hudChrome.mir4.mountTicketDawnDescription':
    '召喚一個坐騎：79% 普通、20% 優秀或 1% 稀有。成功召喚時會消耗召喚券。顯示的模型採用 Aeldrune 原生外觀；列出的 MIR4 屬性為權威資料。',
  'hudChrome.mir4.mountTicketTwilightDescription':
    '召喚一個坐騎：99% 稀有或 1% 史詩。史詩結果在確認後才歸玩家所有。顯示的模型採用 Aeldrune 原生外觀。',
  'hudChrome.mir4.inventoryMounts': '坐騎',
  'hudChrome.mir4.inventoryPendingMounts': '等待確認的坐騎',
  'hudChrome.mir4.mountGrade': '品級 {grade}',
  'hudChrome.mir4.mountOwned': '擁有：{count}',
  'hudChrome.mir4.mountEquipped': '已裝備',
  'hudChrome.mir4.mountEquipHint': '點擊裝備此坐騎並召喚其 Aeldrune 原生外觀。',
  'hudChrome.mir4.mountUnequipHint': '點擊卸下此坐騎並下騎。',
  'hudChrome.mir4.mountConfirmHint': '點擊確認此坐騎並將其加入收藏。',
  'hudChrome.mir4.mountConfirmAria': '確認 {mount}',
  'hudChrome.mir4.mountEffectShell': '採用 Aeldrune 原生模型與 MIR4 坐騎屬性',
  'hudChrome.mir4.mountMoveSpeed': '移動速度：+{amount}%',
  'hudChrome.mir4.mountDefenses': '物理防禦：+{physical} · 魔法防禦：+{magic}',
  'hudChrome.mir4.equippedMountLine': '坐騎：{mount}（品級 {grade}）',
  'hudChrome.mir4.noEquippedMount': '坐騎：未裝備',
  'hudChrome.mir4.inventoryMountCombination': '坐騎合成',
  'hudChrome.mir4.combineMountsAria': '合成四個品級 {grade} 的坐騎',
  'hudChrome.mir4.combineMountsHint':
    '消耗四個此品級的已擁有坐騎。有 20% 機率獲得一個下一品級的隨機坐騎。失敗時獲得一個同品級的隨機坐騎。史詩或更高品質的獎勵需要確認。',
  'hudChrome.mir4.inventorySpirits': '精靈',
  'hudChrome.mir4.inventoryPendingSpirits': '等待確認的精靈',
  'hudChrome.mir4.spiritTicketDawn': '晨曦精靈召喚券',
  'hudChrome.mir4.spiritTicketSunset': '落日精靈召喚券',
  'hudChrome.mir4.spiritTicketDawnDescription':
    '召喚一個精靈：79% 普通、20% 優秀或 1% 稀有。成功召喚時會消耗召喚券。圖示採用 Aeldrune 原生呈現；只有列出的 MIR4 效果生效。',
  'hudChrome.mir4.spiritTicketSunsetDescription':
    '召喚一個精靈：94.5% 優秀、5% 稀有或 0.5% 史詩。史詩結果在確認後才歸玩家所有。成功召喚時會消耗召喚券。',
  'hudChrome.mir4.redeemSpiritTicket': '使用 {ticket} 召喚',
  'hudChrome.mir4.spiritGrade': '品級 {grade}',
  'hudChrome.mir4.spiritOwned': '擁有：{count}',
  'hudChrome.mir4.spiritEquipped': '已裝備',
  'hudChrome.mir4.spiritEquipHint': '點擊裝備此精靈。其屬性和收藏加成會套用到你的 MIR4 屬性。',
  'hudChrome.mir4.spiritUnequipHint': '點擊卸下此精靈。',
  'hudChrome.mir4.spiritConfirmHint': '點擊確認此精靈並將其加入收藏。',
  'hudChrome.mir4.spiritConfirmAria': '確認 {spirit}',
  'hudChrome.mir4.spiritEffectShell': '採用 Aeldrune 原生呈現與 MIR4 精靈效果',
  'hudChrome.mir4.equippedSpiritLine': '精靈：{spirit}（品級 {grade}）',
  'hudChrome.mir4.noEquippedSpirit': '精靈：未裝備',
  'hudChrome.mir4.inventorySpiritCombination': '精靈合成',
  'hudChrome.mir4.combineSpiritsAria': '合成四個品級 {grade} 的精靈',
  'hudChrome.mir4.combineSpiritsHint':
    '消耗四個此品級的已擁有精靈。有 20% 機率獲得一個下一品級的隨機精靈。失敗時獲得一個同品級的隨機精靈。史詩或更高品質的獎勵需要確認。',
  'hudChrome.mir4.spiritSkillChanceCooldown': '{chance}% 機率 · {cooldown}秒冷卻',
  'hudChrome.mir4.spiritSkillBonusDamage': '使觸發攻擊的原始傷害提高 {amount}%。',
  'hudChrome.mir4.spiritSkillExecute':
    '目標生命值不高於 {threshold}% 時，使觸發攻擊的原始傷害提高 {amount}%。',
  'hudChrome.mir4.spiritSkillLifeSiphon': '恢復最大生命值的 {amount}%。',
  'hudChrome.mir4.spiritSkillManaSurge': '恢復最大法力值的 {amount}%。',
  'hudChrome.mir4.spiritSkillArmorRend': '使觸發攻擊獲得 {amount}% 防禦穿透。',
  'hudChrome.mir4.spiritSkillCriticalFocus': '使觸發攻擊必定暴擊。',
  'hudChrome.noticeboard.contract': '已啟用契約：{title}',
  'entities.abilities.mir4_skill_1102.name': '虛空斬',
  'entities.abilities.mir4_skill_1102.description': '對一名敵人造成 {damage} 點傷害。使目標昏迷 0.9 秒。',
  'entities.abilities.mir4_skill_1104.name': '撕裂斬',
  'entities.abilities.mir4_skill_1104.description': '對一名敵人造成 {damage} 點傷害。擊倒目標 1.2 秒。',
  'entities.abilities.mir4_skill_1304.name': '衝撞',
  'entities.abilities.mir4_skill_1304.description':
    '對一名敵人造成 {damage} 點傷害。使目標的物理和魔法防禦降低 12%，持續 4.5 秒。多個破防效果以乘法方式疊加，但防禦不會低於原始值的 20%。上方顯示的是基礎冷卻時間。技能冷卻縮減在 PvE 中最多可降低 40%，在 PvP 中最多可降低 30%。',
  'entities.abilities.mir4_skill_1401.name': '大地重擊',
  ...
  'entities.abilities.mir4_skill_4102.name': '連擊 4102',
  'entities.abilities.mir4_skill_4102.description':
    '對一名敵人造成 {damage} 點傷害。6.625 碼內最多 3 名其他敵人受到 65% 傷害。使目標減速 30%，持續 3.5 秒。',
  'entities.abilities.mir4_skill_4103.description':
    '對一名敵人造成 {damage} 點傷害。7.5 碼內最多 4 名其他敵人受到 55% 傷害。使目標造成的傷害降低 60%，持續 5 秒。',
  ...
  'entities.abilities.mir4_ultimate_2.name': '終極技能',
  'entities.abilities.mir4_ultimate_2.description':
    '透過 4 次打擊造成 {damage} 點傷害。需要終極技能能量全滿。',
  'entities.abilities.mir4_ultimate_3.name': '終極技能',
  'entities.abilities.mir4_ultimate_3.description':
    '透過 3 次打擊造成 {damage} 點傷害。需要終極技能能量全滿。',
  'entities.abilities.mir4_ultimate_4.name': '終極技能',
  'entities.abilities.mir4_ultimate_4.description':
    '透過 3 次打擊造成 {damage} 點傷害。需要終極技能能量全滿。',
  'entities.abilities.mir4_ultimate_5.name': '終極技能',
  'entities.abilities.mir4_ultimate_5.description':
    '透過 2 次打擊造成 {damage} 點傷害。需要終極技能能量全滿。',
  'entities.abilities.mir4_passive_warrior_heavy_armor.name': '重甲',
  'entities.abilities.mir4_passive_warrior_heavy_armor.description': '最大生命值提高 8%。',
  'entities.abilities.mir4_passive_warrior_weapon_mastery.name': '武器精通',
  'entities.abilities.mir4_passive_warrior_weapon_mastery.description': '物理攻擊提高 6%。',
  'entities.abilities.mir4_passive_warrior_iron_skin.description': '物理防禦提高 8%，魔法防禦提高 6%。',
  'entities.abilities.mir4_passive_warrior_fighting_spirit.name': '戰鬥精神',
  'entities.abilities.mir4_passive_warrior_fighting_spirit.description': '最大生命值和物理攻擊提高 4%。',
  'entities.abilities.mir4_passive_warrior_indomitable_will.name': '不屈意志',
  'entities.abilities.mir4_passive_warrior_indomitable_will.description':
    '最大生命值、物理防禦和魔法防禦提高 5%。',
  'entities.abilities.mir4_passive_elementalist_mana_well.description': '最大法力值提高 10%。',
  'entities.abilities.mir4_passive_elementalist_arcane_intellect.name': '奧術智慧',
  'entities.abilities.mir4_passive_elementalist_arcane_intellect.description': '魔法攻擊提高 7%。',
  'entities.abilities.mir4_passive_elementalist_elemental_protection.name': '元素防護',
  'entities.abilities.mir4_passive_elementalist_elemental_protection.description':
    '物理防禦和魔法防禦提高 6%。',
  'entities.abilities.mir4_passive_elementalist_channeling.name': '引導',
  'entities.abilities.mir4_passive_elementalist_channeling.description': '最大法力值提高 5%，魔法攻擊提高 4%。',
  'entities.abilities.mir4_passive_elementalist_arcane_ascension.name': '奧術昇華',
  'entities.abilities.mir4_passive_elementalist_arcane_ascension.description':
    '最大法力值提高 5%，魔法攻擊提高 6%，物理防禦和魔法防禦提高 3%。',
  'entities.abilities.mir4_passive_taoist_spiritual_vessel.name': '靈性容器',
  'entities.abilities.mir4_passive_taoist_spiritual_vessel.description': '最大生命值提高 4%，最大法力值提高 7%。',
  'entities.abilities.mir4_passive_taoist_twin_paths.name': '雙生之道',
  'entities.abilities.mir4_passive_taoist_twin_paths.description': '物理攻擊和魔法攻擊提高 4%。',
  'entities.abilities.mir4_passive_taoist_sacred_guard.name': '神聖守護',
  'entities.abilities.mir4_passive_taoist_sacred_guard.description': '物理防禦和魔法防禦提高 6%。',
  'entities.abilities.mir4_passive_taoist_serene_mind.name': '寧靜心境',
  'entities.abilities.mir4_passive_taoist_serene_mind.description': '最大生命值提高 4%，最大法力值提高 5%。',
  'entities.abilities.mir4_passive_taoist_celestial_harmony.name': '天人和諧',
  'entities.abilities.mir4_passive_taoist_celestial_harmony.description':
    '最大生命值、最大法力值、物理攻擊、魔法攻擊、物理防禦和魔法防禦提高 4%。',
  'entities.abilities.mir4_passive_arbalist_eagle_eye.name': '鷹眼',
  'entities.abilities.mir4_passive_arbalist_eagle_eye.description': '物理攻擊提高 3%，命中提高 5%。',
  'entities.abilities.mir4_passive_arbalist_ballistic_mastery.name': '彈道精通',
  'entities.abilities.mir4_passive_arbalist_ballistic_mastery.description': '物理攻擊提高 7%。',
  'entities.abilities.mir4_passive_arbalist_nature_guard.name': '自然守護',
  'entities.abilities.mir4_passive_arbalist_nature_guard.description':
    '最大生命值、物理防禦和魔法防禦提高 5%。',
  'entities.abilities.mir4_passive_arbalist_hunter_instinct.name': '獵手本能',
  'entities.abilities.mir4_passive_arbalist_hunter_instinct.description': '物理攻擊和閃避提高 5%。',
  'entities.abilities.mir4_passive_arbalist_perfect_shot.name': '完美射擊',
  'entities.abilities.mir4_passive_arbalist_perfect_shot.description':
    '最大生命值提高 3%，物理攻擊提高 6%，命中提高 5%。',
  'entities.abilities.mir4_passive_lancer_war_conditioning.name': '戰爭淬鍊',
  'entities.abilities.mir4_passive_lancer_war_conditioning.description':
    '最大生命值提高 5%，物理攻擊和魔法攻擊提高 3%。',
  'entities.abilities.mir4_passive_lancer_spear_mastery.name': '長槍精通',
  'entities.abilities.mir4_passive_lancer_spear_mastery.description': '物理攻擊和魔法攻擊提高 5%。',
  'entities.abilities.mir4_passive_lancer_vanguard_armor.name': '先鋒鎧甲',
  'entities.abilities.mir4_passive_lancer_vanguard_armor.description': '物理防禦和魔法防禦提高 6%。',
  'entities.abilities.mir4_passive_lancer_battle_rhythm.name': '戰鬥節奏',
  'entities.abilities.mir4_passive_lancer_battle_rhythm.description':
    '最大法力值、物理攻擊和魔法攻擊提高 4%。',
  'entities.abilities.mir4_passive_lancer_dragon_vanguard.name': '龍之先鋒',
  'entities.abilities.mir4_passive_lancer_dragon_vanguard.description':
    '最大生命值提高 4%，物理攻擊、魔法攻擊、物理防禦和魔法防禦提高 5%。',
  'hudChrome.mir4.campaign.questTitle': '戰役 {id}',
  'hudChrome.mir4.campaign.narrative': '完成 {id} 目前的戰役目標。',
  'hudChrome.mir4.campaign.contact': '戰役聯絡人',
  'hudChrome.mir4.campaign.objective.returnToContact': '返回戰役聯絡人處',
  'hudChrome.mir4.campaign.objective.talk': '與戰役聯絡人交談',
  'hudChrome.mir4.campaign.objective.deliver': '交付所需物品',
  'hudChrome.mir4.campaign.objective.travel': '前往標記的目標',
  'hudChrome.mir4.campaign.objective.inspect': '檢查標記的證據',
  'hudChrome.mir4.campaign.objective.gather': '收集所需資源',
  'hudChrome.mir4.campaign.objective.defend': '守衛標記的目標',
  'hudChrome.mir4.campaign.objective.combat': '擊敗標記的敵人',
  'hudChrome.mir4.campaign.objective.escort': '護送標記的盟友',
  'hudChrome.mir4.campaign.objective.escortSupplies': '護送補給隊',
  'hudChrome.mir4.campaign.objective.dungeon': '完成戰役地城',
  'hudChrome.mir4.campaign.objective.craft': '製作所需補給',
  'hudChrome.mir4.campaign.objective.tutorial': '完成系統教學',
  'hudChrome.mir4.campaign.objective.interact': '與標記的目標互動',
  'hudChrome.mir4.campaign.objective.complete': '完成目前目標',
  'hudChrome.spellbook.maxRank': '最高等級',
  'entities.dungeons.campaign_trial_room.name': '戰役試煉',
  'entities.dungeons.campaign_trial_room.enterText': '你進入了戰役試煉。',
  'entities.dungeons.campaign_trial_room.leaveText': '你離開了戰役試煉。',
  'hudChrome.mir4.collectibles.mounts.meadow-courser': '草原駿馬',
  'hudChrome.mir4.collectibles.mounts.moss-boar': '苔藓野猪',
  'hudChrome.mir4.collectibles.mounts.brook-stag': '溪流雄鹿',
  'hudChrome.mir4.collectibles.mounts.gray-wolf': '灰色狼',
  'hudChrome.mir4.collectibles.mounts.dun-packhorse': '褐色馱馬',
  'hudChrome.mir4.collectibles.mounts.birch-doe': '白樺雌鹿',
  'hudChrome.mir4.collectibles.mounts.red-maned-pony': '紅色鬃毛小馬',
  'hudChrome.mir4.collectibles.mounts.lowland-elk': '低地麋鹿',
  'hudChrome.mir4.collectibles.mounts.field-lynx': '原野猞猁',
  'hudChrome.mir4.collectibles.mounts.tawny-mastiff': '黃褐獒犬',
  'hudChrome.mir4.collectibles.mounts.dune-jackal': '沙丘胡狼',
  'hudChrome.mir4.collectibles.mounts.reed-puma': '芦葦美洲獅',
  'hudChrome.mir4.collectibles.mounts.clay-ox': '陶土公牛',
  'hudChrome.mir4.collectibles.mounts.valley-buffalo': '山谷水牛',
  'hudChrome.mir4.collectibles.mounts.shaggy-yak': '長毛犛牛',
  'hudChrome.mir4.collectibles.mounts.creek-lizard': '溪流蜥蜴',
  'hudChrome.mir4.collectibles.mounts.shellback-tortoise': '石甲陸龟',
  'hudChrome.mir4.collectibles.mounts.plains-ostrich': '平原鴕鸟',
  'hudChrome.mir4.collectibles.mounts.dusk-emu': '暮色美洲鴕',
  'hudChrome.mir4.collectibles.mounts.copper-ant-carrier': '銅蚁載獸',
  'hudChrome.mir4.collectibles.mounts.mist-moose': '迷霧驼鹿',
  'hudChrome.mir4.collectibles.mounts.leaf-panther': '葉片黑豹',
  'hudChrome.mir4.collectibles.mounts.turf-rhino': '草皮犀牛',
  'hudChrome.mir4.collectibles.mounts.valley-monitor': '山谷巨蜥',
  'hudChrome.mir4.collectibles.mounts.granite-ibex': '花崗岩岩羊',
  'hudChrome.mir4.collectibles.mounts.silver-dapple-mare': '銀色斑紋母馬',
  'hudChrome.mir4.collectibles.mounts.marsh-stag': '沼澤雄鹿',
  'hudChrome.mir4.collectibles.mounts.snow-mane-lion': '雪鬃雄獅',
  'hudChrome.mir4.collectibles.mounts.ember-fox': '餘烬狐狸',
  'hudChrome.mir4.collectibles.mounts.striped-hyena': '條紋鬣狗',
  'hudChrome.mir4.collectibles.mounts.iron-tusk-boar': '鋼鐵獠牙野猪',
  'hudChrome.mir4.collectibles.mounts.cedar-bear': '雪松熊',
  'hudChrome.mir4.collectibles.mounts.swamp-hippo': '濕地河馬',
  'hudChrome.mir4.collectibles.mounts.thorn-iguana': '荆棘鬣蜥',
  'hudChrome.mir4.collectibles.mounts.dryland-crocodile': '旱地鱷魚',
  'hudChrome.mir4.collectibles.mounts.horned-cassowary': '有角食火雞',
  'hudChrome.mir4.collectibles.mounts.bronze-raptor': '青銅迅猛龍',
  'hudChrome.mir4.collectibles.mounts.amber-scarab': '琥珀圣甲蟲',
  'hudChrome.mir4.collectibles.mounts.dune-scorpion': '沙丘蝎子',
  'hudChrome.mir4.collectibles.mounts.root-golem': '根鬚魔像',
  'hudChrome.mir4.collectibles.mounts.amber-bear': '琥珀熊',
  'hudChrome.mir4.collectibles.mounts.sunset-tiger': '落日猛虎',
  'hudChrome.mir4.collectibles.mounts.root-drake': '根鬚幼龍',
  'hudChrome.mir4.collectibles.mounts.hill-griffin': '山丘獅鷲',
  'hudChrome.mir4.collectibles.mounts.obsidian-zebra': '黑曜石斑馬',
  'hudChrome.mir4.collectibles.mounts.stormhorn-ram': '風暴角公羊',
  'hudChrome.mir4.collectibles.mounts.dusk-elk': '暮色麋鹿',
  'hudChrome.mir4.collectibles.mounts.frost-warg': '寒霜座狼',
  'hudChrome.mir4.collectibles.mounts.basalt-rhino': '玄武岩犀牛',
  'hudChrome.mir4.collectibles.mounts.tundra-mammoth': '凍原猛獁',
  'hudChrome.mir4.collectibles.mounts.crystal-ankylosaur': '水晶甲龍',
  'hudChrome.mir4.collectibles.mounts.ember-salamander': '餘烬火蜥',
  'hudChrome.mir4.collectibles.mounts.thunder-komodo': '雷霆科莫多',
  'hudChrome.mir4.collectibles.mounts.moon-crocodile': '月光鱷魚',
  'hudChrome.mir4.collectibles.mounts.razorbeak-strider': '利刃喙陸行獸',
  'hudChrome.mir4.collectibles.mounts.plume-raptor': '羽冠迅猛龍',
  'hudChrome.mir4.collectibles.mounts.glass-mantis': '玻璃螳螂',
  'hudChrome.mir4.collectibles.mounts.thunder-beetle': '雷霆甲蟲',
  'hudChrome.mir4.collectibles.mounts.iron-sentinel': '鋼鐵哨兵',
  'hudChrome.mir4.collectibles.mounts.mossstone-colossus': '苔石巨像',
  'hudChrome.mir4.collectibles.mounts.eclipse-lion': '日蚀雄獅',
  'hudChrome.mir4.collectibles.mounts.crimson-wyvern': '緋紅雙足飛龍',
  'hudChrome.mir4.collectibles.mounts.astral-stag': '星界雄鹿',
  'hudChrome.mir4.collectibles.mounts.jade-basilisk': '翡翠蛇蜥',
  'hudChrome.mir4.collectibles.mounts.solar-wolf': '太阳狼',
  'hudChrome.mir4.collectibles.mounts.forest-chimera': '森林奇美拉',
  'hudChrome.mir4.collectibles.mounts.tempest-courser': '風暴駿馬',
  'hudChrome.mir4.collectibles.mounts.thorn-elephant': '荆棘巨象',
  'hudChrome.mir4.collectibles.mounts.void-spider': '虛空蜘蛛',
  'hudChrome.mir4.collectibles.mounts.rune-golem': '符文魔像',
  'hudChrome.mir4.collectibles.mounts.dawn-phoenix': '黎明鳳凰',
  'hudChrome.mir4.collectibles.mounts.imperial-griffin': '帝国獅鷲',
  'hudChrome.mir4.collectibles.mounts.stone-leviathan': '岩石利维坦',
  'hudChrome.mir4.collectibles.mounts.void-unicorn': '虛空獨角獸',
  'hudChrome.mir4.collectibles.mounts.golden-manticore': '黃金蝎尾獅',
  'hudChrome.mir4.collectibles.mounts.imperial-tiger': '帝国猛虎',
  'hudChrome.mir4.collectibles.mounts.dawn-mammoth': '黎明猛獁',
  'hudChrome.mir4.collectibles.mounts.magma-drake': '岩浆幼龍',
  'hudChrome.mir4.collectibles.mounts.crown-scorpion': '王冠蝎子',
  'hudChrome.mir4.collectibles.mounts.sunforged-colossus': '日鑄巨像',
  'hudChrome.mir4.collectibles.mounts.ground-dragon': '大地巨龍',
  'hudChrome.mir4.collectibles.mounts.eternal-phoenix': '永恆鳳凰',
  'hudChrome.mir4.collectibles.mounts.celestial-kirin': '天界麒麟',
  'hudChrome.mir4.collectibles.mounts.firmament-behemoth': '苍穹雄獅',
  'hudChrome.mir4.collectibles.mounts.time-hydra': '時間九頭蛇',
  'hudChrome.mir4.collectibles.spirits.spirit-common-01': '草原火花',
  'hudChrome.mir4.collectibles.spirits.spirit-common-02': '溪流微風',
  'hudChrome.mir4.collectibles.spirits.spirit-common-03': '守望葉片',
  'hudChrome.mir4.collectibles.spirits.spirit-common-04': '岩石回声',
  'hudChrome.mir4.collectibles.spirits.spirit-uncommon-01': '黎明輝光',
  'hudChrome.mir4.collectibles.spirits.spirit-uncommon-02': '迷霧宁芙',
  'hudChrome.mir4.collectibles.spirits.spirit-uncommon-03': '苔藓守衛',
  'hudChrome.mir4.collectibles.spirits.spirit-uncommon-04': '山谷火蜥',
  'hudChrome.mir4.collectibles.spirits.spirit-rare-01': '琥珀狐狸',
  'hudChrome.mir4.collectibles.spirits.spirit-rare-02': '落日貓頭鷹',
  'hudChrome.mir4.collectibles.spirits.spirit-rare-03': '根鬚幼龍',
  'hudChrome.mir4.collectibles.spirits.spirit-rare-04': '山丘神諭者',
  'hudChrome.mir4.collectibles.spirits.spirit-epic-01': '日蚀化身',
  'hudChrome.mir4.collectibles.spirits.spirit-epic-02': '緋紅伊弗利特',
  'hudChrome.mir4.collectibles.spirits.spirit-epic-03': '星界雄鹿',
  'hudChrome.mir4.collectibles.spirits.spirit-epic-04': '翡翠哨兵',
  'hudChrome.mir4.collectibles.spirits.spirit-epic-05': '太阳狼',
  'hudChrome.mir4.collectibles.spirits.spirit-epic-06': '以太奇美拉',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-01': '大地泰坦',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-02': '黎明鳳凰',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-03': '帝国執政官',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-04': '水晶利维坦',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-05': '虛空獨角獸',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-06': '黃金蝎尾獅',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-01': '原初靈魂',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-02': '永恆鳳凰',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-03': '天界麒麟',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-04': '苍穹巨獸',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-05': '深淵熾天使',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-06': '時間九頭蛇',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-1-01': '游蕩火花',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-1-02': '暮色本能',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-1-03': '生命甘露',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-1-04': '法力吐息',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-2-01': '升騰閃焰',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-2-02': '迷霧尖牙',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-2-03': '復苏树液',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-2-04': '奥術脉衝',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-3-01': '琥珀破裂',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-3-02': '落日審判',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-3-03': '生命羁絆',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-3-04': '根鬚泉湧',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-01': '日蚀光束',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-02': '緋紅狂怒',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-03': '星界恩典',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-04': '翡翠寶珠',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-05': '太阳斬',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-06': '以太專注',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-01': '地裂衝击',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-02': '重生火焰',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-03': '帝国裁決',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-04': '水晶潮汐',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-05': '虛空裂隙',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-06': '黃金王冠',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-6-01': '創世',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-6-02': '永恆回歸',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-6-03': '天界敕令',
  ...
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-6-06': '絕對瞬間',
  ...
  'hudChrome.mir4.stats.healthPotionEffect': '生命藥水效果',
  'hudChrome.mir4.stats.manaPotionEffect': '法力藥水效果',
  'hudChrome.mir4.stats.basicAttackDamage': '普通攻擊傷害',
  'hudChrome.mir4.stats.basicDamageReduction': '普通攻擊傷害減免',
  'hudChrome.mir4.skillCooldownDisclosure':
    '上方顯示的是基礎冷卻時間。技能冷卻縮減在 PvE 中最多可降低 40%，在 PvP 中最多可降低 30%。',
