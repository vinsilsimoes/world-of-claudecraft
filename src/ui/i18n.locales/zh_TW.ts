...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.mir4.equipmentVisualShell': '採用 World of ClaudeCraft 外觀與 MIR4 戰鬥屬性',
  ...
  'hudChrome.mir4.inventoryRuntimeItems': 'World of ClaudeCraft 原生物品',
  ...
  'hudChrome.mir4.mountTicketDawnDescription':
    '召喚一個坐騎：79% 普通、20% 優秀或 1% 稀有。成功召喚時會消耗召喚券。顯示的模型採用 World of ClaudeCraft 原生外觀；列出的 MIR4 屬性為權威資料。',
  'hudChrome.mir4.mountTicketTwilightDescription':
    '召喚一個坐騎：99% 稀有或 1% 史詩。史詩結果在確認後才歸玩家所有。顯示的模型採用 World of ClaudeCraft 原生外觀。',
  ...
  'hudChrome.mir4.mountEquipHint': '點擊裝備此坐騎並召喚其 World of ClaudeCraft 原生外觀。',
  ...
  'hudChrome.mir4.mountEffectShell': '採用 World of ClaudeCraft 原生模型與 MIR4 坐騎屬性',
  ...
  'hudChrome.mir4.spiritTicketDawnDescription':
    '召喚一個精靈：79% 普通、20% 優秀或 1% 稀有。成功召喚時會消耗召喚券。圖示採用 World of ClaudeCraft 原生呈現；只有列出的 MIR4 效果生效。',
  ...
  'hudChrome.mir4.spiritEffectShell': '採用 World of ClaudeCraft 原生呈現與 MIR4 精靈效果',
