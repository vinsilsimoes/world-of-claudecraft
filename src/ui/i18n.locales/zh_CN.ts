...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.wallet.unlinked':
    '连接钱包应用，然后签名一次，将其公开地址绑定到你的 Aeldrune 账号。我们绝不会获取你的恢复短语或私钥。',
  'hudChrome.wocStore.wallet.connectedUnlinked':
    '钱包应用已连接到此浏览器，但其公开地址尚未绑定到你的 Aeldrune 账号。',
  ...
  'seo.officialLabel': 'Aeldrune 官方网站',
  'seo.officialBody':
    'Aeldrune 是 Aelvarin 世界的官方免费浏览器 MMO。你可以用持久角色在线游玩，也可以离线单人探索，阅读 wiki，并从本站访问已验证的社区链接。',
  ...
  'wallet.standaloneAppHelp':
    '主屏幕应用暂不支持连接钱包。若要使用 Phantom 或 Solflare，请在 Safari 或 Chrome 中打开 Aeldrune。',
  ...
  'wallet.manualReturnStandaloneHelp':
    '批准后请从主屏幕返回 Aeldrune。如果 iOS 打开了浏览器，请将其关闭并重新打开主屏幕应用。',
  ...
  'wallet.browser.safety': 'Aeldrune 绝不会索要助记词或私钥。',
  ...
  'wallet.browser.completeBody': '现在可以返回 Aeldrune 桌面应用。',
  ...
  'playerCard.shareText':
    '我正在 Aeldrune 中铸就传说：{level}级 {className}{tierBit}。加入我的世界：',
  ...
  'controls.chat': '打开聊天框',
  'seo.title': 'Aeldrune：经典风格网页 MMO',
  'seo.description':
    '在 Aeldrune 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的世界，提升职业等级，击败敌人！',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人游戏',
  ...
  'a11y.githubProject': '打开 Aeldrune 的 GitHub 项目',
  'a11y.discordCommunity': '加入 Aeldrune 的 Discord 社区',
  'a11y.donateProject': '捐赠支持 Aeldrune',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '从新的主屏幕图标打开 Aeldrune。',
  ...
  'guide.worldPage.intro': 'Aeldrune 是一片你要靠双脚走遍的连续大陆。古道自南向北穿过起始山谷、沼泽和山峰，并越过它们继续攀升，通向其后的洼地以及地图顶端的雪境。自那条路向西展开一列更高等级的国度，向东另有一列，谷地东岸外还有一座岛屿。这里没有快速旅行，没有飞行路线，也没有马车：每一段路程都靠步行或骑乘完成，所以抵达本身就是冒险的一部分。\n\n这片大地也记录着时间。昼夜循环依照一只你所在世界人人共享的真实时钟运转，因此天空会为你们所有人同时从黎明经正午走向黄昏与夜色，月亮循着盈亏来去，地面上的光影也随之变化。小地图周围的表盘，就是你读取时辰的地方。',
  ...
  'hudChrome.discord.swag.titleChampion': '称号：Aelvarin 勇士',
  ...
  'hudChrome.nativeUpdate.body':
    'Aeldrune 有新版本可用。立即更新以获取最新修复和改进。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Aeldrune {version} 版本已可用。立即更新以获取最新修复和改进。',
  ...
  'desktop.notify.updateReadyBody': '重启 Aeldrune 以应用更新。',
  ...
  'desktop.crash.fatalBody': 'Aeldrune 遇到意外错误，需要关闭。',
  ...
  'editor.docTitle': '地图编辑器 - Aeldrune',
  ...
  'hudChrome.wiki.confirmBody': '将在浏览器中打开 Aeldrune 维基，游戏会继续运行。',
  ...
  'hudChrome.perf.diagnostics.panelAria': 'Aeldrune 性能诊断',
  'hudChrome.perf.diagnostics.title': 'Aeldrune 性能医生',
  ...
  'hudChrome.perf.diagnostics.report.title': 'Aeldrune 性能诊断',
  ...
  'classes.elementalist': '元素师',
  'classes.taoist': '道士',
  'classes.arbalist': '弩手',
  'classes.lancer': '枪骑士',
  'classes.elementalistAria': '元素师职业',
  'classes.taoistAria': '道士职业',
  'classes.arbalistAria': '弩手职业',
  'classes.lancerAria': '枪骑士职业',
  'classDetails.mir4.labels.damage': '伤害',
  'classDetails.mir4.labels.combatRange': '战斗距离',
  'classDetails.mir4.labels.startingSkills': '初始技能',
  'classDetails.mir4.damage.physical': '物理',
  'classDetails.mir4.damage.magic': '魔法',
  'classDetails.mir4.range.melee': '近战',
  'classDetails.mir4.range.medium': '中距离',
  'classDetails.mir4.range.long': '远距离',
  'classDetails.mir4.range.extended': '扩展近战',
  'classDetails.mir4.weapons.heavySword': '重剑',
  'classDetails.mir4.weapons.largeStaff': '长法杖',
  'classDetails.mir4.weapons.shortStaff': '短法杖',
  'classDetails.mir4.weapons.arbalest': '弩',
  'classDetails.mir4.weapons.spear': '长枪',
  'classDetails.mir4.aria':
    '{className}职业详情：{damage}伤害，{range}距离，武器为{weapon}，拥有{skills}个初始技能。',
  'abilityUi.actionBar.autoBattleName': '自动战斗',
  'abilityUi.actionBar.autoBattleTooltip':
    '切换当前位置周围的自动索敌、移动和技能循环。',
  'hudChrome.questTracker.mir4.firstTraces': '最初的痕迹',
  'hudChrome.questTracker.mir4.reachTarek': '前往塔雷克处',
  'hudChrome.questTracker.mir4.inspectClues': '检查线索',
  'hudChrome.questTracker.mir4.returnToTarek': '返回塔雷克处',
  'hudChrome.questTracker.mir4.pausedSuffix': '（自动旅程因手动操作而暂停）',
  'hudChrome.questTracker.mir4.startAutoJourney': '开始自动旅程',
  'hudChrome.questTracker.mir4.stopAutoJourney': '停止自动旅程',
  'hudChrome.mir4.ultimateGauge': '终极技能能量',
  'hudChrome.mir4.ultimateGaugeStatus': '终极技能能量：{value}/{max}',
  'hudChrome.mir4.ultimateReadyAnnouncement': '终极技能已就绪。',
  'hudChrome.mir4.achievements.title': '成就',
  'hudChrome.mir4.achievements.close': '关闭成就',
  'hudChrome.mir4.achievements.summary': '已领取奖励：{claimed}/{total}',
  'hudChrome.mir4.achievements.balances':
    '铜币 {copper} · 黑铁 {darksteel} · 效果点数 {effectPoints} · 技能秘籍 {skillTomes}',
  'hudChrome.mir4.achievements.levelTitle': '等级 {level}',
  'hudChrome.mir4.achievements.levelDescription': '达到等级 {level}。',
  'hudChrome.mir4.achievements.progressAria': '等级进度：{current}/{target}',
  'hudChrome.mir4.achievements.progressText': '{current}／{target}',
  'hudChrome.mir4.achievements.rewardCopper': '铜币 {amount}',
  'hudChrome.mir4.achievements.rewardDarksteel': '黑铁 {amount}',
  'hudChrome.mir4.achievements.rewardEffectPoints': '效果点数 {amount}',
  'hudChrome.mir4.achievements.rewardSkillTomes': '技能秘籍 {amount} 本',
  'hudChrome.mir4.achievements.rewards': '奖励：{rewards}',
  'hudChrome.mir4.achievements.claim': '领取',
  'hudChrome.mir4.achievements.claimed': '已领取',
  'hudChrome.mir4.achievements.locked': '达到等级 {level}',
  'hudChrome.mir4.achievements.previousGrade': '请先领取上一阶段奖励',
  'hudChrome.mir4.achievements.claimAria': '领取等级 {level} 成就奖励',
  'hudChrome.mir4.questLog.narrative':
    '调查渡口周围的三个线索地点，然后返回塔雷克·双桥处。',
  'hudChrome.mir4.questLog.giverName': '塔雷克·双桥',
  'hudChrome.mir4.questLog.emptyHint': '在 M01 聚落找到塔雷克·双桥，或开始自动旅程。',
  'hudChrome.mir4.questLog.completedHint': '“最初的痕迹”已完成。其余战役任务尚未激活。',
  'hudChrome.mir4.characterTitle': '角色',
  'hudChrome.mir4.awaitingState': '正在等待权威角色数据……',
  'hudChrome.mir4.combatPowerLine': '战力 {value}',
  'hudChrome.mir4.equipmentVisualShell': '采用 Aeldrune 外观与 MIR4 战斗属性',
  'hudChrome.mir4.equipmentTierGrade': '阶层 {tier}，品级 {grade}',
  'hudChrome.mir4.equipmentRequiredLevel': '需要等级 {level}',
  'hudChrome.mir4.unequipHint': '点击 X 或右键点击以卸下。',
  'hudChrome.mir4.unequipAria': '卸下 {item}',
  'hudChrome.mir4.equipHint': '点击装备。',
  'hudChrome.mir4.equipAria': '装备 {item}',
  'hudChrome.mir4.equipmentSlots.weapon': '武器',
  'hudChrome.mir4.equipmentSlots.necklace': '项链',
  'hudChrome.mir4.equipmentSlots.talisman': '护符',
  'hudChrome.mir4.equipmentSlots.chest': '胸甲',
  'hudChrome.mir4.equipmentSlots.helmet': '头盔',
  'hudChrome.mir4.equipmentSlots.gloves': '手套',
  'hudChrome.mir4.equipmentSlots.boots': '靴子',
  'hudChrome.mir4.stats.combatPower': '战力',
  'hudChrome.mir4.stats.maxHp': '最大生命值',
  'hudChrome.mir4.stats.maxMana': '最大法力值',
  'hudChrome.mir4.stats.physicalAttack': '物理攻击',
  'hudChrome.mir4.stats.magicAttack': '魔法攻击',
  'hudChrome.mir4.stats.physicalDefense': '物理防御',
  'hudChrome.mir4.stats.magicDefense': '魔法防御',
  'hudChrome.mir4.stats.accuracy': '命中',
  'hudChrome.mir4.stats.dodge': '闪避',
  'hudChrome.mir4.stats.critical': '暴击',
  'hudChrome.mir4.stats.avoidCritical': '暴击闪避',
  'hudChrome.mir4.stats.criticalOutcome': '暴击伤害',
  ...
  'hudChrome.mir4.materials.solarScroll': '太阳卷轴',
  'hudChrome.mir4.materials.lunarSeal': '月之印',
  'hudChrome.mir4.materials.solarWard': '太阳护符',
  'hudChrome.mir4.maps.portal': '{zone}传送门',
  'hudChrome.mir4.maps.actWelcome': '{zone}（第{act}幕）。',
  'hudChrome.mir4.maps.m01': '渡口村',
  'hudChrome.mir4.maps.m02': '芦苇小径',
  'hudChrome.mir4.maps.m03': '山谷林地',
  'hudChrome.mir4.maps.m04': '山坡遗迹',
  'hudChrome.mir4.maps.m05': '裂隙林间地',
  'hudChrome.mir4.maps.m06': '烛石墓穴',
  'hudChrome.mir4.maps.m07': '藏骨回廊',
  'hudChrome.mir4.maps.m08': '雾石要塞',
  'hudChrome.mir4.maps.m09': '灯笼沼泽',
  'hudChrome.mir4.maps.m11': '水蛭红树林',
  'hudChrome.mir4.maps.m12': '芦苇港',
  'hudChrome.mir4.maps.m13': '玻璃沙丘',
  'hudChrome.mir4.maps.m14': '阿赫特死灵城',
  'hudChrome.mir4.maps.m15': '烬岩火山口',
  'hudChrome.mir4.maps.m16': '破碎太阳熔炉',
  'hudChrome.mir4.maps.m17': '呼啸苔原',
  'hudChrome.mir4.maps.m19': '夜幕',
  'hudChrome.mir4.maps.m20': '日蚀堡垒',
  'hudChrome.mir4.progression.title': '装备工坊',
  'hudChrome.mir4.progression.refinement': '精炼',
  'hudChrome.mir4.progression.enchantment': '附魔',
  'hudChrome.mir4.progression.blessing': '祝福',
  'hudChrome.mir4.progression.crafting': '制作',
  'hudChrome.mir4.progression.ownedEquipment': '已拥有装备',
  'hudChrome.mir4.progression.noEquipment': '此操作没有可用装备。',
  'hudChrome.mir4.progression.equipped': '已装备',
  'hudChrome.mir4.progression.enhancementLevel': '强化 +{level}/+{max}',
  'hudChrome.mir4.progression.successChance': '成功率：{chance}%',
  'hudChrome.mir4.progression.safeFailure': '失败时保留装备。',
  'hudChrome.mir4.progression.destructiveFailure': '+5 以上强化失败会摧毁装备。',
  'hudChrome.mir4.progression.wardProtection': '将消耗一个太阳护符以防止装备被摧毁。',
  'hudChrome.mir4.progression.noWardProtection': '没有可用的太阳护符。',
  'hudChrome.mir4.progression.enhanceCost': '费用：1 个太阳卷轴',
  'hudChrome.mir4.progression.enhance': '强化',
  'hudChrome.mir4.progression.maxEnhancement': '已达到最高强化等级',
  ...
  'hudChrome.mir4.progression.acceptPreview': '应用预览',
  'hudChrome.mir4.progression.keepCurrent': '保留当前效果',
  'hudChrome.mir4.progression.inactiveEffect': '已移植效果（尚未在战斗中生效）',
  'hudChrome.mir4.progression.materialRecipes': '材料配方',
  'hudChrome.mir4.progression.campaignProfession': '战役专业订单',
  'hudChrome.mir4.progression.campaignProfessionProgress': '进度：{current}/{goal}',
  'hudChrome.mir4.progression.campaignProfessionMaterials': '合格材料：{held}/{needed}',
  'hudChrome.mir4.progression.campaignProfessionHint':
    '在战役制作锚点完成此订单。服务器只会消耗权威的地区材料。',
  'hudChrome.mir4.progression.campaignCraft': '制作组件',
  'hudChrome.mir4.progression.campaignRefine': '精炼组件',
  'hudChrome.mir4.progression.campaignSalvage': '分解装备',
  'hudChrome.mir4.progression.creates': '制作 {count} 个{material}',
  'hudChrome.mir4.progression.copperCost': '{amount} 铜币',
  'hudChrome.mir4.progression.create': '制作',
  'hudChrome.mir4.progression.requestSent': '服务器正在验证装备操作。',
  'hudChrome.mir4.inventoryEquipment': '装备',
  'hudChrome.mir4.inventoryRuntimeItems': 'Aeldrune 原生物品',
  'hudChrome.mir4.inventoryCollectionTickets': '收藏券',
  'hudChrome.mir4.inventoryMaterials': '精炼材料',
  'hudChrome.mir4.noUnequippedEquipment': '没有未装备的装备。',
  'hudChrome.mir4.materialCount': '拥有：{count}',
  'hudChrome.mir4.mountTicketDawn': '晨曦坐骑召唤券',
  'hudChrome.mir4.mountTicketTwilight': '暮光坐骑召唤券',
  'hudChrome.mir4.mountTicketDawnDescription':
    '召唤一个坐骑：79% 普通、20% 优秀或 1% 稀有。成功召唤时会消耗召唤券。显示的模型采用 Aeldrune 原生外观；列出的 MIR4 属性为权威数据。',
  'hudChrome.mir4.mountTicketTwilightDescription':
    '召唤一个坐骑：99% 稀有或 1% 史诗。史诗结果在确认后才归玩家所有。显示的模型采用 Aeldrune 原生外观。',
  'hudChrome.mir4.inventoryMounts': '坐骑',
  'hudChrome.mir4.inventoryPendingMounts': '等待确认的坐骑',
  'hudChrome.mir4.mountGrade': '品级 {grade}',
  'hudChrome.mir4.mountOwned': '拥有：{count}',
  'hudChrome.mir4.mountEquipped': '已装备',
  'hudChrome.mir4.mountEquipHint': '点击装备此坐骑并召唤其 Aeldrune 原生外观。',
  'hudChrome.mir4.mountUnequipHint': '点击卸下此坐骑并下坐骑。',
  'hudChrome.mir4.mountConfirmHint': '点击确认此坐骑并将其加入收藏。',
  'hudChrome.mir4.mountConfirmAria': '确认 {mount}',
  'hudChrome.mir4.mountEffectShell': '采用 Aeldrune 原生模型与 MIR4 坐骑属性',
  'hudChrome.mir4.mountMoveSpeed': '移动速度：+{amount}%',
  'hudChrome.mir4.mountDefenses': '物理防御：+{physical} · 魔法防御：+{magic}',
  'hudChrome.mir4.equippedMountLine': '坐骑：{mount}（品级 {grade}）',
  'hudChrome.mir4.noEquippedMount': '坐骑：未装备',
  'hudChrome.mir4.inventoryMountCombination': '坐骑合成',
  'hudChrome.mir4.combineMountsAria': '合成四个品级 {grade} 的坐骑',
  'hudChrome.mir4.combineMountsHint':
    '消耗四个此品级的已拥有坐骑。有 20% 几率获得一个下一品级的随机坐骑。失败时获得一个同品级的随机坐骑。史诗或更高品质的奖励需要确认。',
  'hudChrome.mir4.inventorySpirits': '精灵',
  'hudChrome.mir4.inventoryPendingSpirits': '等待确认的精灵',
  'hudChrome.mir4.spiritTicketDawn': '晨曦精灵召唤券',
  'hudChrome.mir4.spiritTicketSunset': '落日精灵召唤券',
  'hudChrome.mir4.spiritTicketDawnDescription':
    '召唤一个精灵：79% 普通、20% 优秀或 1% 稀有。成功召唤时会消耗召唤券。图标采用 Aeldrune 原生表现；只有列出的 MIR4 效果生效。',
  'hudChrome.mir4.spiritTicketSunsetDescription':
    '召唤一个精灵：94.5% 优秀、5% 稀有或 0.5% 史诗。史诗结果在确认后才归玩家所有。成功召唤时会消耗召唤券。',
  'hudChrome.mir4.redeemSpiritTicket': '使用 {ticket} 召唤',
  'hudChrome.mir4.spiritGrade': '品级 {grade}',
  'hudChrome.mir4.spiritOwned': '拥有：{count}',
  'hudChrome.mir4.spiritEquipped': '已装备',
  'hudChrome.mir4.spiritEquipHint': '点击装备此精灵。其属性和收藏加成会应用到你的 MIR4 属性。',
  'hudChrome.mir4.spiritUnequipHint': '点击卸下此精灵。',
  'hudChrome.mir4.spiritConfirmHint': '点击确认此精灵并将其加入收藏。',
  'hudChrome.mir4.spiritConfirmAria': '确认 {spirit}',
  'hudChrome.mir4.spiritEffectShell': '采用 Aeldrune 原生表现与 MIR4 精灵效果',
  'hudChrome.mir4.equippedSpiritLine': '精灵：{spirit}（品级 {grade}）',
  'hudChrome.mir4.noEquippedSpirit': '精灵：未装备',
  'hudChrome.mir4.inventorySpiritCombination': '精灵合成',
  'hudChrome.mir4.combineSpiritsAria': '合成四个品级 {grade} 的精灵',
  'hudChrome.mir4.combineSpiritsHint':
    '消耗四个此品级的已拥有精灵。有 20% 几率获得一个下一品级的随机精灵。失败时获得一个同品级的随机精灵。史诗或更高品质的奖励需要确认。',
  'hudChrome.mir4.spiritSkillChanceCooldown': '{chance}% 几率 · {cooldown}秒冷却',
  'hudChrome.mir4.spiritSkillBonusDamage': '使触发攻击的原始伤害提高 {amount}%。',
  'hudChrome.mir4.spiritSkillExecute':
    '目标生命值不高于 {threshold}% 时，使触发攻击的原始伤害提高 {amount}%。',
  'hudChrome.mir4.spiritSkillLifeSiphon': '恢复最大生命值的 {amount}%。',
  'hudChrome.mir4.spiritSkillManaSurge': '恢复最大法力值的 {amount}%。',
  'hudChrome.mir4.spiritSkillArmorRend': '使触发攻击获得 {amount}% 防御穿透。',
  'hudChrome.mir4.spiritSkillCriticalFocus': '使触发攻击必定暴击。',
  'hudChrome.noticeboard.contract': '已激活契约：{title}',
  'entities.abilities.mir4_skill_1102.name': '虚空斩',
  'entities.abilities.mir4_skill_1102.description': '对一名敌人造成 {damage} 点伤害。使目标昏迷 0.9 秒。',
  'entities.abilities.mir4_skill_1104.name': '撕裂斩',
  ...
  'entities.abilities.mir4_skill_1501.name': '疾风斩',
  'entities.abilities.mir4_skill_1501.description':
    '对一名敌人造成 {damage} 点伤害。7.75 码内最多 4 名其他敌人受到 65% 伤害。使每个命中的敌人减速 35%，持续 3.2 秒。',
  'entities.abilities.mir4_skill_2101.name': '火焰球',
  'entities.abilities.mir4_skill_2101.description':
    '对一名敌人造成 {damage} 点伤害。6.5 码内最多 3 名其他敌人受到 65% 伤害。灼烧每个命中的敌人，每 1 秒造成 {burnPerTick} 点基础伤害（共 4 次，减伤前总计 {burnTotal} 点）。伤害取决于施加灼烧时你的法术强度。',
  'entities.abilities.mir4_skill_2111.name': '冰霜球',
  'entities.abilities.mir4_skill_2111.description':
    '对一名敌人造成 {damage} 点伤害。6.5 码内最多 3 名其他敌人受到 65% 伤害。使每个命中的敌人减速 35%，持续 3.2 秒。',
  ...
  'entities.abilities.mir4_skill_2501.name': '唤出核心',
  'entities.abilities.mir4_skill_2501.description':
    '对一名敌人造成 {damage} 点伤害。8 码内最多 4 名其他敌人受到 60% 伤害。冻结目标 1.8 秒。',
  'entities.abilities.mir4_skill_2503.name': '魔法护盾',
  ...
  'entities.abilities.mir4_skill_3104.description':
    '以 4 次攻击造成 {damage} 点混合伤害。7.75 码内最多 4 名其他敌人受到 60% 伤害。达到 8 阶后，每个命中的敌人有 40% 几率被沉默 4 秒。',
  'entities.abilities.mir4_skill_3301.name': '图腾之印 II',
  'entities.abilities.mir4_skill_3301.description':
    '对一名敌人造成 {damage} 点伤害。7.25 码内最多 3 名其他敌人受到 60% 伤害。使目标减速 35%，持续 4.2 秒。',
  'entities.abilities.mir4_skill_3503.name': '玉莲',
  'entities.abilities.mir4_skill_3503.description': '恢复最大生命值的 18%。',
  'entities.abilities.mir4_skill_3506.name': '图腾之印 I',
  'entities.abilities.mir4_skill_3506.description':
    '对一名敌人造成 {damage} 点伤害。7 码内最多 3 名其他敌人受到 60% 伤害。定身目标 1.6 秒。',
  'entities.abilities.mir4_skill_4101.name': '爆发 4101',
  'entities.abilities.mir4_skill_4101.description':
    '对一名敌人造成 {damage} 点伤害。7 码内最多 3 名其他敌人受到 65% 伤害。使目标造成的伤害降低 45%，持续 3.5 秒。',
  'entities.abilities.mir4_skill_4102.name': '连击 4102',
  'entities.abilities.mir4_skill_4102.description':
    '对一名敌人造成 {damage} 点伤害。6.625 码内最多 3 名其他敌人受到 65% 伤害。使目标减速 30%，持续 3.5 秒。',
  'entities.abilities.mir4_skill_4103.description':
    '对一名敌人造成 {damage} 点伤害。7.5 码内最多 4 名其他敌人受到 55% 伤害。使目标造成的伤害降低 60%，持续 5 秒。',
  'entities.abilities.mir4_skill_4106.name': '冲锋 4106',
  'entities.abilities.mir4_skill_4106.description': '对一名敌人造成 {damage} 点伤害。使目标昏迷 2 秒。',
  'entities.abilities.mir4_skill_4107.name': '闪光箭',
  'entities.abilities.mir4_skill_4107.description':
    '对一名敌人造成 {damage} 点伤害。6.75 码内最多 3 名其他敌人受到 60% 伤害，并使其造成的伤害降低 45%，持续 5 秒。',
  ...
  'entities.abilities.mir4_skill_5301.name': '锁链 5301',
  'entities.abilities.mir4_skill_5301.description':
    '对一名敌人造成 {damage} 点伤害。7.25 码内最多 3 名其他敌人受到 70% 伤害。使目标昏迷 0.9 秒。',
  'entities.abilities.mir4_skill_5401.name': '横扫风暴',
  'entities.abilities.mir4_skill_5401.description':
    '造成 {damage} 点混合伤害，并使敌人造成的伤害降低 30%，持续 5 秒。',
  'entities.abilities.mir4_ultimate_1.name': '终极技能',
  'entities.abilities.mir4_ultimate_1.description':
    '通过 3 次打击造成 {damage} 点伤害。需要终极技能能量全满。',
  'entities.abilities.mir4_ultimate_2.name': '终极技能',
  'entities.abilities.mir4_ultimate_2.description':
    '通过 4 次打击造成 {damage} 点伤害。需要终极技能能量全满。',
  'entities.abilities.mir4_ultimate_3.name': '终极技能',
  'entities.abilities.mir4_ultimate_3.description':
    '通过 3 次打击造成 {damage} 点伤害。需要终极技能能量全满。',
  'entities.abilities.mir4_ultimate_4.name': '终极技能',
  'entities.abilities.mir4_ultimate_4.description':
    '通过 3 次打击造成 {damage} 点伤害。需要终极技能能量全满。',
  'entities.abilities.mir4_ultimate_5.name': '终极技能',
  'entities.abilities.mir4_ultimate_5.description':
    '通过 2 次打击造成 {damage} 点伤害。需要终极技能能量全满。',
  ...
  'entities.abilities.mir4_passive_warrior_weapon_mastery.description': '物理攻击提高 6%。',
  'entities.abilities.mir4_passive_warrior_iron_skin.description': '物理防御提高 8%，魔法防御提高 6%。',
  'entities.abilities.mir4_passive_warrior_fighting_spirit.name': '战斗精神',
  'entities.abilities.mir4_passive_warrior_fighting_spirit.description': '最大生命值和物理攻击提高 4%。',
  ...
  'entities.abilities.mir4_passive_elementalist_arcane_intellect.name': '奥术智慧',
  'entities.abilities.mir4_passive_elementalist_arcane_intellect.description': '魔法攻击提高 7%。',
  'entities.abilities.mir4_passive_elementalist_elemental_protection.name': '元素防护',
  'entities.abilities.mir4_passive_elementalist_elemental_protection.description':
    '物理防御和魔法防御提高 6%。',
  'entities.abilities.mir4_passive_elementalist_channeling.name': '引导',
  'entities.abilities.mir4_passive_elementalist_channeling.description': '最大法力值提高 5%，魔法攻击提高 4%。',
  'entities.abilities.mir4_passive_elementalist_arcane_ascension.name': '奥术升华',
  'entities.abilities.mir4_passive_elementalist_arcane_ascension.description':
    '最大法力值提高 5%，魔法攻击提高 6%，物理防御和魔法防御提高 3%。',
  'entities.abilities.mir4_passive_taoist_spiritual_vessel.name': '灵性容器',
  'entities.abilities.mir4_passive_taoist_spiritual_vessel.description': '最大生命值提高 4%，最大法力值提高 7%。',
  'entities.abilities.mir4_passive_taoist_twin_paths.name': '双生之道',
  'entities.abilities.mir4_passive_taoist_twin_paths.description': '物理攻击和魔法攻击提高 4%。',
  'entities.abilities.mir4_passive_taoist_sacred_guard.name': '神圣守护',
  'entities.abilities.mir4_passive_taoist_sacred_guard.description': '物理防御和魔法防御提高 6%。',
  'entities.abilities.mir4_passive_taoist_serene_mind.name': '宁静心境',
  'entities.abilities.mir4_passive_taoist_serene_mind.description': '最大生命值提高 4%，最大法力值提高 5%。',
  'entities.abilities.mir4_passive_taoist_celestial_harmony.name': '天人和谐',
  'entities.abilities.mir4_passive_taoist_celestial_harmony.description':
    '最大生命值、最大法力值、物理攻击、魔法攻击、物理防御和魔法防御提高 4%。',
  'entities.abilities.mir4_passive_arbalist_eagle_eye.name': '鹰眼',
  'entities.abilities.mir4_passive_arbalist_eagle_eye.description': '物理攻击提高 3%，命中提高 5%。',
  'entities.abilities.mir4_passive_arbalist_ballistic_mastery.name': '弹道精通',
  'entities.abilities.mir4_passive_arbalist_ballistic_mastery.description': '物理攻击提高 7%。',
  'entities.abilities.mir4_passive_arbalist_nature_guard.name': '自然守护',
  'entities.abilities.mir4_passive_arbalist_nature_guard.description':
    '最大生命值、物理防御和魔法防御提高 5%。',
  'entities.abilities.mir4_passive_arbalist_hunter_instinct.name': '猎手本能',
  'entities.abilities.mir4_passive_arbalist_hunter_instinct.description': '物理攻击和闪避提高 5%。',
  'entities.abilities.mir4_passive_arbalist_perfect_shot.name': '完美射击',
  'entities.abilities.mir4_passive_arbalist_perfect_shot.description':
    '最大生命值提高 3%，物理攻击提高 6%，命中提高 5%。',
  'entities.abilities.mir4_passive_lancer_war_conditioning.name': '战争淬炼',
  'entities.abilities.mir4_passive_lancer_war_conditioning.description':
    '最大生命值提高 5%，物理攻击和魔法攻击提高 3%。',
  'entities.abilities.mir4_passive_lancer_spear_mastery.name': '长枪精通',
  'entities.abilities.mir4_passive_lancer_spear_mastery.description': '物理攻击和魔法攻击提高 5%。',
  'entities.abilities.mir4_passive_lancer_vanguard_armor.name': '先锋铠甲',
  'entities.abilities.mir4_passive_lancer_vanguard_armor.description': '物理防御和魔法防御提高 6%。',
  'entities.abilities.mir4_passive_lancer_battle_rhythm.name': '战斗节奏',
  'entities.abilities.mir4_passive_lancer_battle_rhythm.description':
    '最大法力值、物理攻击和魔法攻击提高 4%。',
  'entities.abilities.mir4_passive_lancer_dragon_vanguard.name': '龙之先锋',
  'entities.abilities.mir4_passive_lancer_dragon_vanguard.description':
    '最大生命值提高 4%，物理攻击、魔法攻击、物理防御和魔法防御提高 5%。',
  'hudChrome.mir4.campaign.questTitle': '战役 {id}',
  'hudChrome.mir4.campaign.narrative': '完成 {id} 当前的战役目标。',
  'hudChrome.mir4.campaign.contact': '战役联系人',
  'hudChrome.mir4.campaign.objective.returnToContact': '返回战役联系人处',
  'hudChrome.mir4.campaign.objective.talk': '与战役联系人交谈',
  'hudChrome.mir4.campaign.objective.deliver': '交付所需物品',
  'hudChrome.mir4.campaign.objective.travel': '前往标记的目标',
  'hudChrome.mir4.campaign.objective.inspect': '检查标记的证据',
  'hudChrome.mir4.campaign.objective.gather': '收集所需资源',
  'hudChrome.mir4.campaign.objective.defend': '守卫标记的目标',
  'hudChrome.mir4.campaign.objective.combat': '击败标记的敌人',
  'hudChrome.mir4.campaign.objective.escort': '护送标记的盟友',
  'hudChrome.mir4.campaign.objective.escortSupplies': '护送补给队',
  'hudChrome.mir4.campaign.objective.dungeon': '完成战役地下城',
  'hudChrome.mir4.campaign.objective.craft': '制作所需补给',
  'hudChrome.mir4.campaign.objective.tutorial': '完成系统教学',
  'hudChrome.mir4.campaign.objective.interact': '与标记的目标互动',
  'hudChrome.mir4.campaign.objective.complete': '完成当前目标',
  'hudChrome.spellbook.maxRank': '最高等级',
  'entities.dungeons.campaign_trial_room.name': '战役试炼',
  'entities.dungeons.campaign_trial_room.enterText': '你进入了战役试炼。',
  'entities.dungeons.campaign_trial_room.leaveText': '你离开了战役试炼。',
  'hudChrome.mir4.collectibles.mounts.meadow-courser': '草原骏马',
  ...
  'hudChrome.mir4.collectibles.mounts.dun-packhorse': '褐色驮马',
  'hudChrome.mir4.collectibles.mounts.birch-doe': '白桦雌鹿',
  'hudChrome.mir4.collectibles.mounts.red-maned-pony': '红色鬃毛小马',
  'hudChrome.mir4.collectibles.mounts.lowland-elk': '低地麋鹿',
  'hudChrome.mir4.collectibles.mounts.field-lynx': '原野猞猁',
  'hudChrome.mir4.collectibles.mounts.tawny-mastiff': '黄褐獒犬',
  'hudChrome.mir4.collectibles.mounts.dune-jackal': '沙丘胡狼',
  'hudChrome.mir4.collectibles.mounts.reed-puma': '芦苇美洲狮',
  'hudChrome.mir4.collectibles.mounts.clay-ox': '陶土公牛',
  'hudChrome.mir4.collectibles.mounts.valley-buffalo': '山谷水牛',
  'hudChrome.mir4.collectibles.mounts.shaggy-yak': '长毛牦牛',
  'hudChrome.mir4.collectibles.mounts.creek-lizard': '溪流蜥蜴',
  'hudChrome.mir4.collectibles.mounts.shellback-tortoise': '石甲陆龟',
  'hudChrome.mir4.collectibles.mounts.plains-ostrich': '平原鸵鸟',
  'hudChrome.mir4.collectibles.mounts.dusk-emu': '暮色美洲鸵',
  'hudChrome.mir4.collectibles.mounts.copper-ant-carrier': '铜蚁载兽',
  'hudChrome.mir4.collectibles.mounts.mist-moose': '迷雾驼鹿',
  'hudChrome.mir4.collectibles.mounts.leaf-panther': '叶片黑豹',
  'hudChrome.mir4.collectibles.mounts.turf-rhino': '草皮犀牛',
  'hudChrome.mir4.collectibles.mounts.valley-monitor': '山谷巨蜥',
  'hudChrome.mir4.collectibles.mounts.granite-ibex': '花岗岩岩羊',
  'hudChrome.mir4.collectibles.mounts.silver-dapple-mare': '银色斑纹母马',
  'hudChrome.mir4.collectibles.mounts.marsh-stag': '沼泽雄鹿',
  'hudChrome.mir4.collectibles.mounts.snow-mane-lion': '雪鬃雄狮',
  'hudChrome.mir4.collectibles.mounts.ember-fox': '余烬狐狸',
  'hudChrome.mir4.collectibles.mounts.striped-hyena': '条纹鬣狗',
  'hudChrome.mir4.collectibles.mounts.iron-tusk-boar': '钢铁獠牙野猪',
  'hudChrome.mir4.collectibles.mounts.cedar-bear': '雪松熊',
  'hudChrome.mir4.collectibles.mounts.swamp-hippo': '湿地河马',
  'hudChrome.mir4.collectibles.mounts.thorn-iguana': '荆棘鬣蜥',
  'hudChrome.mir4.collectibles.mounts.dryland-crocodile': '旱地鳄鱼',
  'hudChrome.mir4.collectibles.mounts.horned-cassowary': '有角食火鸡',
  'hudChrome.mir4.collectibles.mounts.bronze-raptor': '青铜迅猛龙',
  'hudChrome.mir4.collectibles.mounts.amber-scarab': '琥珀圣甲虫',
  'hudChrome.mir4.collectibles.mounts.dune-scorpion': '沙丘蝎子',
  'hudChrome.mir4.collectibles.mounts.root-golem': '根须魔像',
  'hudChrome.mir4.collectibles.mounts.amber-bear': '琥珀熊',
  'hudChrome.mir4.collectibles.mounts.sunset-tiger': '落日猛虎',
  'hudChrome.mir4.collectibles.mounts.root-drake': '根须幼龙',
  'hudChrome.mir4.collectibles.mounts.hill-griffin': '山丘狮鹫',
  'hudChrome.mir4.collectibles.mounts.obsidian-zebra': '黑曜石斑马',
  'hudChrome.mir4.collectibles.mounts.stormhorn-ram': '风暴角公羊',
  ...
  'hudChrome.mir4.collectibles.mounts.tundra-mammoth': '冻原猛犸',
  'hudChrome.mir4.collectibles.mounts.crystal-ankylosaur': '水晶甲龙',
  'hudChrome.mir4.collectibles.mounts.ember-salamander': '余烬火蜥',
  'hudChrome.mir4.collectibles.mounts.thunder-komodo': '雷霆科莫多',
  'hudChrome.mir4.collectibles.mounts.moon-crocodile': '月光鳄鱼',
  'hudChrome.mir4.collectibles.mounts.razorbeak-strider': '利刃喙陆行兽',
  'hudChrome.mir4.collectibles.mounts.plume-raptor': '羽冠迅猛龙',
  'hudChrome.mir4.collectibles.mounts.glass-mantis': '玻璃螳螂',
  'hudChrome.mir4.collectibles.mounts.thunder-beetle': '雷霆甲虫',
  'hudChrome.mir4.collectibles.mounts.iron-sentinel': '钢铁哨兵',
  'hudChrome.mir4.collectibles.mounts.mossstone-colossus': '苔石巨像',
  'hudChrome.mir4.collectibles.mounts.eclipse-lion': '日蚀雄狮',
  'hudChrome.mir4.collectibles.mounts.crimson-wyvern': '绯红双足飞龙',
  ...
  'hudChrome.mir4.collectibles.mounts.tempest-courser': '风暴骏马',
  'hudChrome.mir4.collectibles.mounts.thorn-elephant': '荆棘巨象',
  'hudChrome.mir4.collectibles.mounts.void-spider': '虚空蜘蛛',
  'hudChrome.mir4.collectibles.mounts.rune-golem': '符文魔像',
  'hudChrome.mir4.collectibles.mounts.dawn-phoenix': '黎明凤凰',
  'hudChrome.mir4.collectibles.mounts.imperial-griffin': '帝国狮鹫',
  'hudChrome.mir4.collectibles.mounts.stone-leviathan': '岩石利维坦',
  'hudChrome.mir4.collectibles.mounts.void-unicorn': '虚空独角兽',
  'hudChrome.mir4.collectibles.mounts.golden-manticore': '黄金蝎尾狮',
  'hudChrome.mir4.collectibles.mounts.imperial-tiger': '帝国猛虎',
  'hudChrome.mir4.collectibles.mounts.dawn-mammoth': '黎明猛犸',
  'hudChrome.mir4.collectibles.mounts.magma-drake': '岩浆幼龙',
  'hudChrome.mir4.collectibles.mounts.crown-scorpion': '王冠蝎子',
  'hudChrome.mir4.collectibles.mounts.sunforged-colossus': '日铸巨像',
  'hudChrome.mir4.collectibles.mounts.ground-dragon': '大地巨龙',
  'hudChrome.mir4.collectibles.mounts.eternal-phoenix': '永恒凤凰',
  'hudChrome.mir4.collectibles.mounts.celestial-kirin': '天界麒麟',
  'hudChrome.mir4.collectibles.mounts.firmament-behemoth': '苍穹雄狮',
  'hudChrome.mir4.collectibles.mounts.time-hydra': '时间九头蛇',
  'hudChrome.mir4.collectibles.spirits.spirit-common-01': '草原火花',
  'hudChrome.mir4.collectibles.spirits.spirit-common-02': '溪流微风',
  'hudChrome.mir4.collectibles.spirits.spirit-common-03': '守望叶片',
  'hudChrome.mir4.collectibles.spirits.spirit-common-04': '岩石回声',
  'hudChrome.mir4.collectibles.spirits.spirit-uncommon-01': '黎明辉光',
  'hudChrome.mir4.collectibles.spirits.spirit-uncommon-02': '迷雾宁芙',
  'hudChrome.mir4.collectibles.spirits.spirit-uncommon-03': '苔藓守卫',
  'hudChrome.mir4.collectibles.spirits.spirit-uncommon-04': '山谷火蜥',
  'hudChrome.mir4.collectibles.spirits.spirit-rare-01': '琥珀狐狸',
  'hudChrome.mir4.collectibles.spirits.spirit-rare-02': '落日猫头鹰',
  'hudChrome.mir4.collectibles.spirits.spirit-rare-03': '根须幼龙',
  'hudChrome.mir4.collectibles.spirits.spirit-rare-04': '山丘神谕者',
  'hudChrome.mir4.collectibles.spirits.spirit-epic-01': '日蚀化身',
  'hudChrome.mir4.collectibles.spirits.spirit-epic-02': '绯红伊弗利特',
  ...
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-02': '黎明凤凰',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-03': '帝国执政官',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-04': '水晶利维坦',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-05': '虚空独角兽',
  'hudChrome.mir4.collectibles.spirits.spirit-legendary-06': '黄金蝎尾狮',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-01': '原初灵魂',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-02': '永恒凤凰',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-03': '天界麒麟',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-04': '苍穹巨兽',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-05': '深渊炽天使',
  'hudChrome.mir4.collectibles.spirits.spirit-mythical-06': '时间九头蛇',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-1-01': '游荡火花',
  ...
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-2-01': '升腾闪焰',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-2-02': '迷雾尖牙',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-2-03': '复苏树液',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-2-04': '奥术脉冲',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-3-01': '琥珀破裂',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-3-02': '落日审判',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-3-03': '生命羁绊',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-3-04': '根须泉涌',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-01': '日蚀光束',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-02': '绯红狂怒',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-03': '星界恩典',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-04': '翡翠宝珠',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-05': '太阳斩',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-4-06': '以太专注',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-01': '地裂冲击',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-02': '重生火焰',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-03': '帝国裁决',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-04': '水晶潮汐',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-05': '虚空裂隙',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-5-06': '黄金王冠',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-6-01': '创世',
  'hudChrome.mir4.collectibles.spiritSkills.spirit-skill-6-02': '永恒回归',
