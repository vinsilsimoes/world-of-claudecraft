...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.mir4.equipmentVisualShell': '采用 World of ClaudeCraft 外观与 MIR4 战斗属性',
  ...
  'hudChrome.mir4.mountTicketDawnDescription':
    '召唤一个坐骑：79% 普通、20% 优秀或 1% 稀有。成功召唤时会消耗召唤券。显示的模型采用 World of ClaudeCraft 原生外观；列出的 MIR4 属性为权威数据。',
  'hudChrome.mir4.mountTicketTwilightDescription':
    '召唤一个坐骑：99% 稀有或 1% 史诗。史诗结果在确认后才归玩家所有。显示的模型采用 World of ClaudeCraft 原生外观。',
  ...
  'hudChrome.mir4.mountEquipHint': '点击装备此坐骑并召唤其 World of ClaudeCraft 原生外观。',
  ...
  'hudChrome.mir4.mountEffectShell': '采用 World of ClaudeCraft 原生模型与 MIR4 坐骑属性',
  ...
  'hudChrome.mir4.spiritTicketDawnDescription':
    '召唤一个精灵：79% 普通、20% 优秀或 1% 稀有。成功召唤时会消耗召唤券。图标采用 World of ClaudeCraft 原生表现；只有列出的 MIR4 效果生效。',
  ...
  'hudChrome.mir4.spiritEffectShell': '采用 World of ClaudeCraft 原生表现与 MIR4 精灵效果',
