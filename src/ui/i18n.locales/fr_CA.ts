...
export const fr_CA: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.title': 'Aeldrune: MMO Web de style classique',
  'seo.description':
    'Lancez-vous dans une aventure épique dans Aeldrune, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un monde partagé et persistant, faites monter vos classes en niveau et terrassez vos ennemis.',
  ...
  'serverUnavailable.body':
    'Nous redémarrons le service de jeu et Aelvarin devrait revenir sous peu. Cette page continuera de vérifier automatiquement.',
