...
const UI_PURE_CORES = [
  ...
  'src/ui/hud/vendor/mir4_village_equipment_view.ts',
  ...
  'src/ui/mir4_album_view.ts',
  'src/ui/mir4_character_view.ts',
  'src/ui/mir4_inventory_view.ts',
  'src/ui/mir4_codex_view.ts',
  'src/ui/mir4_growth_view.ts',
  'src/ui/mir4_mount_codex_view.ts',
  'src/ui/mir4_progression_view.ts',
  'src/ui/mir4_result_overlay_view.ts',
  'src/ui/mir4_spirit_codex_view.ts',
  ...
  'src/ui/hud/action_bar/mir4_action_tools_view.ts',
...
const RENDER_PURE_CORES = [
  'src/render/mir4_down_reaction_core.ts',
  'src/render/mir4_native_skill_presentation_core.ts',
  'src/render/mir4_skill_guide_core.ts',
  ...
  'src/render/characters/attack_timing_core.ts',
...
const UI_DOM_MODULES = [
  ...
  'src/ui/hud/action_bar/hotbar_drag_controller.ts',
  'src/ui/hud/action_bar/mir4_auto_skill_toggle_controller.ts',
  'src/ui/hud/action_bar/mir4_action_tools_controller.ts',
  'src/ui/mir4_result_overlay_controller.ts',
